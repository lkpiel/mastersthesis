...
train_labels_age_group_dnn = np.load("../dnn/dnn_predicted_labels.npy")

train_labels = ( train_labels_age_group + train_labels_age_group_dnn ) / 2
...
np.save('/home/hpc_lkpiel/predictions/val/model_75.npy', val_predictions)
print ("VAL SAVED")

np.save('/home/hpc_lkpiel/predictions/test/model_75.npy', test_predictions)
print ("TEST SAVED")
'''
