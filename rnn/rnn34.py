...
model_34 = Sequential([
    Conv2D(128, (3, 20), kernel_regularizer=kernel_regularizer,  border_mode='valid', input_shape=(1107, 20, 1)),
...
print ("model_34 BUILT")

model_34.compile(loss='categorical_crossentropy', optimizer="adam", metrics=['accuracy'])
print ("model_34 COMPILED")


checkpoint = ModelCheckpoint(filepath='/home/hpc_lkpiel/models/model_34.hdf5', monitor='val_loss', save_best_only=True)

history = model_34.fit(x=train_data_padded,
...
np.save('../history/history_model_34.npy', history.history)
modelHistory = np.load('../history/history_model_34.npy').item()

print ("HISTORY: ")
print (modelHistory)
model_34.load_weights('/home/hpc_lkpiel/models/model_34.hdf5')

valResult = model_34.evaluate(val_data_padded, val_labels_age_group)
testResult = model_34.evaluate(test_data_padded, test_labels_age_group)

file = open("results.txt","a")
file.write("\nmodel_34 VAL: " + str(valResult) + " TEST: " + str(testResult))
file.close()
print ("WROTE TO FILE model_34")
