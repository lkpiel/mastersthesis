...
print ("model_37 BUILT")

model_37.compile(loss='categorical_crossentropy', optimizer="adam", metrics=['accuracy'])
print ("model_37 COMPILED")


checkpoint = ModelCheckpoint(filepath='/home/hpc_lkpiel/models/model_37.hdf5', monitor='val_acc', save_best_only=True)
'''
history = model_37.fit(x=train_data_padded,
...
np.save('../history/history_model_37.npy', history.history)
modelHistory = np.load('../history/history_model_37.npy').item()

print ("HISTORY: ")
print (modelHistory)
'''

model_37.load_weights('/home/hpc_lkpiel/models/model_37.hdf5')
val_predictions = model_37.predict(val_data_padded)
print ("VAL PREDICTED")

test_predictions = model_37.predict(test_data_padded)
print ("TEST PREDICTED")

np.save('/home/hpc_lkpiel/predictions/val/model_37.npy', val_predictions)
print ("VAL SAVED")

np.save('/home/hpc_lkpiel/predictions/test/model_37.npy', test_predictions)

'''
valResult = model_37.evaluate(val_data_padded, val_labels_age_group)
testResult = model_37.evaluate(test_data_padded, test_labels_age_group)

file = open("results.txt","a")
file.write("\nmodel_37 VAL: " + str(valResult) + " TEST: " + str(testResult))
file.close()
print ("WROTE TO FILE model_37")
