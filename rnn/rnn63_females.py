...
trainFemaleIndexes = train_data_i_vectors.index[train_data_i_vectors['Gender'] == 1].tolist()
train_data_i_vectors = train_data_i_vectors[train_data_i_vectors['Gender'] == 1]
...
val_data_i_vectors = val_data_i_vectors[val_data_i_vectors['Gender'] == 1]
...
test_data_i_vectors = test_data_i_vectors[test_data_i_vectors['Gender'] == 1]
...
print ("model_63_females BUILT")
model_63_females = Model(inputs=[input_layer, input_layer_2], outputs=output_layer_1)

model_63_females.compile(loss='categorical_crossentropy',
                    optimizer=SGD(0.01),
                    metrics=['accuracy'])

print ("model_63_females COMPILED")


checkpoint = ModelCheckpoint(filepath='/home/hpc_lkpiel/models/model_63_females_sgd.hdf5', monitor='val_acc', save_best_only=True)


history = model_63_females.fit([train_data_padded, train_data_i_vectors],
...
np.save('../history/history_model_63_females_sgd.npy', history.history)
modelHistory = np.load('../history/history_model_63_females_sgd.npy').item()

print ("HISTORY: ")
print (modelHistory)

model_63_females.load_weights('/home/hpc_lkpiel/models/model_63_females_sgd.hdf5')


val_predictions = model_63_females.predict([val_data_padded, val_data_i_vectors])
print ("VAL PREDICTED")

test_predictions = model_63_females.predict([test_data_padded, test_data_i_vectors])
print ("TEST PREDICTED")


np.save('/home/hpc_lkpiel/predictions/val/model_63_females_sgd.npy', val_predictions)
print ("VAL SAVED")

np.save('/home/hpc_lkpiel/predictions/test/model_63_females_sgd.npy', test_predictions)
print ("TEST SAVED")


valResult = model_63_females.evaluate([val_data_padded, val__data_i_vectors], val_labels_age_group)
testResult = model_63_females.evaluate([test_data_padded, test_data_i_vectors], test_labels_age_group)

file = open("results.txt","a")
file.write("\nmodel_63_females VAL: " + str(valResult) + " TEST: " + str(testResult))
file.close()
print ("WROTE TO FILE model_63_females")
