...
print (model_85.summary)
print ("model_85 BUILT")

model_85.compile(loss='categorical_crossentropy', optimizer="adam", metrics=['accuracy'])
print ("model_85 COMPILED")


checkpoint = ModelCheckpoint(filepath='/home/hpc_lkpiel/models/model_85.hdf5', monitor='val_loss', save_best_only=True)
'''
history = model_85.fit(x=train_data_padded,
...
np.save('../history/history_model_85.npy', history.history)
modelHistory = np.load('../history/history_model_85.npy').item()

print ("HISTORY: ")
print (modelHistory)
'''
model_85.load_weights('/home/hpc_lkpiel/models/model_85.hdf5')

val_predictions = model_85.predict(val_data_padded)
print ("VAL PREDICTED")

test_predictions = model_85.predict(test_data_padded)
print ("TEST PREDICTED")


np.save('/home/hpc_lkpiel/predictions/val/model_85.npy', val_predictions)
print ("VAL SAVED")

np.save('/home/hpc_lkpiel/predictions/test/model_85.npy', test_predictions)
print ("TEST SAVED")
'''
valResult = model_85.evaluate(val_data_padded, val_labels_age_group)
testResult = model_85.evaluate(test_data_padded, test_labels_age_group)

file = open("results.txt","a")
file.write("\nmodel_85 VAL: " + str(valResult) + " TEST: " + str(testResult))
file.close()
print ("WROTE TO FILE")
'''
########################################