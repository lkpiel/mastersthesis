...
model_42.load_weights('/home/hpc_lkpiel/models/model_42.hdf5')


checkpoint = ModelCheckpoint(filepath='/home/hpc_lkpiel/models/model_42.hdf5', monitor='val_acc', save_best_only=True)
'''
...
np.save('/home/hpc_lkpiel/predictions/val/model_42_males_original.npy', val_predictions)
print ("VAL SAVED")

np.save('/home/hpc_lkpiel/predictions/test/model_42_males_original.npy', test_predictions)
