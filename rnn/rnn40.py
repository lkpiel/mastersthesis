...
model_40.load_weights('/models/model_41.hdf5')


checkpoint = ModelCheckpoint(filepath='/models/model_40.hdf5', monitor='val_acc', save_best_only=True)
...
print ("HISTORY: ")
print (modelHistory)
model_40.load_weights('/models/model_40.hdf5')
