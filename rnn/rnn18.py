...
print ("model_18 BUILT")

model_18.compile(loss='categorical_crossentropy', optimizer='adam', metrics=['accuracy'])
print ("model_18 COMPILED")


checkpoint = ModelCheckpoint(filepath='/home/hpc_lkpiel/models/model_18.hdf5', monitor='val_acc', save_best_only=True)

history = model_18.fit(x=train_data_padded,
...
np.save('../history/history_model_18.npy', history.history)
modelHistory = np.load('../history/history_model_18.npy').item()

print ("HISTORY: ")
print (modelHistory)
model_18.load_weights('/home/hpc_lkpiel/models/model_18.hdf5')

valResult = model_18.evaluate(val_data_padded, val_labels_age_group)
testResult = model_18.evaluate(test_data_padded, test_labels_age_group)

file = open("results.txt","a")
file.write("\nmodel_18 VAL: " + str(valResult) + " TEST: " + str(testResult))
file.close()
print ("WROTE TO FILE")
