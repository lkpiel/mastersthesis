...
x = Conv2D(128, (3, 20), activation='relu', border_mode='valid', input_shape=(1107, 20, 1))(input_layer)
x = Conv2D(128, (3, 1), activation='relu', border_mode='valid')(x)
x = Conv2D(128, (3, 1), activation='relu', border_mode='valid')(x)
x = Conv2D(128, (3, 1), activation='relu', border_mode='valid')(x)
x = Reshape((-1, 128))(x)
...
print ("model_86 BUILT")
model_86 = Model(inputs=[input_layer, input_layer_2], outputs=output_layer_1)

model_86.compile(loss='categorical_crossentropy',
                    optimizer=SGD(0.01),
                    metrics=['accuracy'])

print ("model_86 COMPILED")


checkpoint = ModelCheckpoint(filepath='/home/hpc_lkpiel/models/model_86_males.hdf5', monitor='val_acc', save_best_only=True)


history = model_86.fit([train_data_padded, train_i_vectors_males],
    [train_labels_males],
...
np.save('../history/history_model_86_males.npy', history.history)
modelHistory = np.load('../history/history_model_86_males.npy').item()

print ("HISTORY: ")
print (modelHistory)

model_86.load_weights('/home/hpc_lkpiel/models/model_86_males.hdf5')
val_predictions = model_86.predict([val_data_padded, val_i_vectors_males])
print ("VAL PREDICTED")

test_predictions = model_86.predict([test_data_padded, test_i_vectors_males])
print ("TEST PREDICTED")




np.save('/home/hpc_lkpiel/predictions/val/model_86_males.npy', val_predictions)

print ("VAL SAVED")

np.save('/home/hpc_lkpiel/predictions/test/model_86_males.npy', test_predictions)
