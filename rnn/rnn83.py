...
print (model_83.summary)
print ("model_83 BUILT")

model_83.compile(loss='categorical_crossentropy', optimizer="adam", metrics=['accuracy'])
print ("model_83 COMPILED")


checkpoint = ModelCheckpoint(filepath='/home/hpc_lkpiel/models/model_83.hdf5', monitor='val_loss', save_best_only=True)

history = model_83.fit(x=train_data_padded,
...
np.save('../history/history_model_83.npy', history.history)
modelHistory = np.load('../history/history_model_83.npy').item()

print ("HISTORY: ")
print (modelHistory)
model_83.load_weights('/home/hpc_lkpiel/models/model_83.hdf5')

valResult = model_83.evaluate(val_data_padded, val_labels_age_group)
testResult = model_83.evaluate(test_data_padded, test_labels_age_group)

file = open("results.txt","a")
file.write("\nmodel_83 VAL: " + str(valResult) + " TEST: " + str(testResult))
file.close()
print ("WROTE TO FILE")
