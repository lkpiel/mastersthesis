...
checkpoint = ModelCheckpoint(filepath='/home/hpc_lkpiel/models/model_31.hdf5', monitor='val_loss', save_best_only=True)
'''
...
print (modelHistory)
'''
model_31.load_weights('/home/hpc_lkpiel/models/model_31.hdf5')
