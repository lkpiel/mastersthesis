...
checkpoint = ModelCheckpoint(filepath='/models/model_75.hdf5', monitor='val_acc', save_best_only=True)
model_75.load_weights('/models/model_69.hdf5')
'''
...
print (modelHistory)
'''
model_75.load_weights('/models/model_75.hdf5')
