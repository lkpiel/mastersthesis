...
print ("model_75 BUILT")

model_75.compile(loss='categorical_crossentropy', optimizer=SGD(0.01), metrics=['accuracy'])
print ("model_75 COMPILED")


checkpoint = ModelCheckpoint(filepath='/home/hpc_lkpiel/models/model_75.hdf5', monitor='val_acc', save_best_only=True)
model_75.load_weights('/home/hpc_lkpiel/models/model_69.hdf5')
'''
history = model_75.fit(x=train_data_padded,
        y=train_labels,
...
np.save('../history/history_model_75.npy', history.history)
modelHistory = np.load('../history/history_model_75.npy').item()

print ("HISTORY: ")
print (modelHistory)
'''
model_75.load_weights('/home/hpc_lkpiel/models/model_75.hdf5')


val_predictions = model_75.predict(val_data_padded)
print ("VAL PREDICTED")

test_predictions = model_75.predict(test_data_padded)
print ("TEST PREDICTED")

np.save('/home/hpc_lkpiel/predictions/val/model_75_females_original.npy', val_predictions)
print ("VAL SAVED")

np.save('/home/hpc_lkpiel/predictions/test/model_75_females_original.npy', test_predictions)
print ("TEST SAVED")
'''
valResult = model_75.evaluate(val_data_padded, val_labels_age_group)
testResult = model_75.evaluate(test_data_padded, test_labels_age_group)

file = open("results.txt","a")
file.write("\nmodel_75 VAL: " + str(valResult) + " TEST: " + str(testResult))
file.close()
'''
print ("WROTE TO FILE model_75")
