...
print ("model_90 COMPILED")


checkpoint = ModelCheckpoint(filepath='/home/hpc_lkpiel/models/model_90.hdf5', monitor='val_acc', save_best_only=True)

'''
history = model_90.fit([train_data_padded, train_i_vectors],
    [train_labels_gender],
    validation_data=([val_data_padded, val_i_vectors], [val_labels_gender]),
    epochs=30,
    verbose=1,
    batch_size=128,
...
np.save('../history/history_model_90.npy', history.history)
modelHistory = np.load('../history/history_model_90.npy').item()
...
val_predictions = model_90.predict([val_data_padded, val_i_vectors])
print ("VAL PREDICTED")

test_predictions = model_90.predict([test_data_padded, test_i_vectors])
print ("TEST PREDICTED")


np.save('/home/hpc_lkpiel/predictions/val/model_90.npy', val_predictions)
print ("VAL SAVED")

np.save('/home/hpc_lkpiel/predictions/test/model_90.npy', test_predictions)
print ("TEST SAVED")

valResult = model_90.evaluate([val_data_padded, val_i_vectors], val_labels_age)
testResult = model_90.evaluate([test_data_padded, test_i_vectors], test_labels_age)

print (str(valResult))
print (str(testResult))
print ("WROTE TO FILE model_90")
