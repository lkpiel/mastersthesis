...
model_92 = Sequential([
    TimeDistributed(Dense(3000, activation='relu'),  input_shape=(1107, 20)),
    Dropout(0.7),
...
print (model_92.summary)
print ("model_92 BUILT")

model_92.compile(loss='categorical_crossentropy', optimizer="sgd", metrics=['accuracy'])
print ("model_92 COMPILED")


checkpoint = ModelCheckpoint(filepath='/home/hpc_lkpiel/models/model_92.hdf5', monitor='val_loss', save_best_only=True)

history = model_92.fit(x=train_data_padded,
...
np.save('../history/history_model_92.npy', history.history)
modelHistory = np.load('../history/history_model_92.npy').item()

print ("HISTORY: ")
print (modelHistory)
model_92.load_weights('/home/hpc_lkpiel/models/model_92.hdf5')

valResult = model_92.evaluate(val_data_padded, val_labels_age_group)
testResult = model_92.evaluate(test_data_padded, test_labels_age_group)

file = open("results.txt","a")
file.write("\nmodel_92 VAL: " + str(valResult) + " TEST: " + str(testResult))
file.close()
print ("WROTE TO FILE")
