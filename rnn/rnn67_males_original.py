...
checkpoint = ModelCheckpoint(filepath='/home/hpc_lkpiel/models/model_67.hdf5', monitor='val_acc', save_best_only=True)
...
print (modelHistory)
'''
model_67.load_weights('/home/hpc_lkpiel/models/model_67.hdf5')

val_predictions = model_67.predict([val_data_padded, val_i_vectors_males])
print ("VAL PREDICTED")

test_predictions = model_67.predict([test_data_padded, test_i_vectors_males])
print ("TEST PREDICTED")


np.save('/home/hpc_lkpiel/predictions/val/model_67_males_original.npy', val_predictions)
print ("VAL SAVED")

np.save('/home/hpc_lkpiel/predictions/test/model_67_males_original.npy', test_predictions)
print ("TEST SAVED")
'''
