...
checkpoint = ModelCheckpoint(filepath='/models/model_68_females.hdf5', monitor='val_acc', save_best_only=True)
...
model_68.load_weights('/models/model_68_females.hdf5')
