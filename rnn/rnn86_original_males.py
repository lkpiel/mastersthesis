...
checkpoint = ModelCheckpoint(filepath='/home/hpc_lkpiel/models/model_86.hdf5', monitor='val_acc', save_best_only=True)

'''
history = model_86.fit([train_data_padded, train_i_vectors],
...
np.save('../history/history_model_86.npy', history.history)
modelHistory = np.load('../history/history_model_86.npy').item()

print ("HISTORY: ")
print (modelHistory)
'''
model_86.load_weights('/home/hpc_lkpiel/models/model_86.hdf5')
...
np.save('/home/hpc_lkpiel/predictions/val/model_86_males_original.npy', val_predictions)

print ("VAL SAVED")

np.save('/home/hpc_lkpiel/predictions/test/model_86_males_original.npy', test_predictions)
