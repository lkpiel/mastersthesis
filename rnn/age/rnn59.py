...
print ("model_59 BUILT")
model_59 = Model(inputs=[input_layer, input_layer_2], outputs=output_layer_1)

model_59.compile(loss='categorical_crossentropy',
                    optimizer="sgd",
                    metrics=['accuracy'])

print ("model_59 COMPILED")


checkpoint = ModelCheckpoint(filepath='/home/hpc_lkpiel/models/model_59.hdf5', monitor='val_acc', save_best_only=True)

'''
history = model_59.fit([train_data_padded, train_i_vectors],
...
np.save('../history/history_model_59.npy', history.history)
modelHistory = np.load('../history/history_model_59.npy').item()

print ("HISTORY: ")
print (modelHistory)
'''
model_59.load_weights('/home/hpc_lkpiel/models/model_59.hdf5')


val_predictions = model_59.predict([val_data_padded, val_i_vectors])
print ("VAL PREDICTED")

test_predictions = model_59.predict([test_data_padded, test_i_vectors])
print ("TEST PREDICTED")


np.save('/home/hpc_lkpiel/predictions/val/model_59.npy', val_predictions)
print ("VAL SAVED")

np.save('/home/hpc_lkpiel/predictions/test/model_59.npy', test_predictions)

valResult = model_59.evaluate([val_data_padded, val_i_vectors], val_labels_age_group)

testResult = model_59.evaluate([test_data_padded, test_i_vectors], test_labels_age_group)

file = open("results.txt","a")
file.write("\nmodel_59 VAL: " + str(valResult) + " TEST: " + str(testResult))
file.close()
print ("WROTE TO FILE model_59")
