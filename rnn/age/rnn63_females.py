...
checkpoint = ModelCheckpoint(filepath='/models/model_63_females_sgd.hdf5', monitor='val_acc', save_best_only=True)
...
model_63_females.load_weights('/models/model_63_females_sgd.hdf5')
