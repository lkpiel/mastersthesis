...
train_labels_age = np.load("./randomized_train_labels_0_8.npy")
...
np.save('../history/history_model_55.npy', history.history)
modelHistory = np.load('../history/history_model_55.npy').item()
...
file.write("\nmodel_55 VAL: " + str(valResult) + " TEST: " + str(testResult))
file.close()
print ("WROTE TO FILE model_55")
