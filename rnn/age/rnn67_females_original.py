...
val_predictions = model_67.predict([val_data_padded, val_i_vectors_females])
print ("VAL PREDICTED")

test_predictions = model_67.predict([test_data_padded, test_i_vectors_females])
print ("TEST PREDICTED")


np.save('/home/hpc_lkpiel/predictions/val/model_67_females_original.npy', val_predictions)
print ("VAL SAVED")

np.save('/home/hpc_lkpiel/predictions/test/model_67_females_original.npy', test_predictions)
print ("TEST SAVED")
'''
