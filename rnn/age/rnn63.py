...
val_predictions = model_63.predict([val_data_padded, val_i_vectors])
print ("VAL PREDICTED")

test_predictions = model_63.predict([test_data_padded, test_i_vectors])
print ("TEST PREDICTED")


np.save('/home/hpc_lkpiel/predictions/val/model_63.npy', val_predictions)
print ("VAL SAVED")

np.save('/home/hpc_lkpiel/predictions/test/model_63.npy', test_predictions)

valResult = model_63.evaluate([val_data_padded, val_i_vectors], val_labels_age_group)
testResult = model_63.evaluate([test_data_padded, test_i_vectors], test_labels_age_group)
