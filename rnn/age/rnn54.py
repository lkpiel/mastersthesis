...
for i in range(train_labels_age.size):
    x.append(train_labels_age[i] + random.uniform(-0.1, 0.1))
train_labels_age = np.array(x)
np.save("./randomized_train_labels_0_1", train_labels_age)
...
print ("model_54 BUILT")

model_54.compile(loss='mse', optimizer=SGD(0.01), metrics=[age_group_accuracy])
print ("model_54 COMPILED")

checkpoint = ModelCheckpoint(filepath='/home/hpc_lkpiel/models/model_54.hdf5', monitor='val_age_group_accuracy', save_best_only=True)
model_54.load_weights('/home/hpc_lkpiel/models/model_51.hdf5')
'''
history = model_54.fit(x=train_data_padded,
        y=train_labels_age,
...
np.save('../history/history_model_54.npy', history.history)
modelHistory = np.load('../history/history_model_54.npy').item()

print ("HISTORY: ")
print (modelHistory)
'''
model_54.load_weights('/home/hpc_lkpiel/models/model_54.hdf5')

val_predictions = model_54.predict(val_data_padded)
print ("VAL PREDICTED")

test_predictions = model_54.predict(test_data_padded)
print ("TEST PREDICTED")


np.save('/home/hpc_lkpiel/predictions/val/model_54.npy', val_predictions)
print ("VAL SAVED")

np.save('/home/hpc_lkpiel/predictions/test/model_54.npy', test_predictions)
print ("TEST SAVED")
print ("WROTE TO FILE model_54")
