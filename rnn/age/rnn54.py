...
checkpoint = ModelCheckpoint(filepath='/models/model_54.hdf5', monitor='val_age_group_accuracy', save_best_only=True)
model_54.load_weights('/models/model_51.hdf5')
'''
...
print (modelHistory)
'''
model_54.load_weights('/models/model_54.hdf5')
