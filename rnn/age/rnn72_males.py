...
checkpoint = ModelCheckpoint(filepath='/home/hpc_lkpiel/models/model_72_males.hdf5', monitor='val_acc', save_best_only=True)


history = model_72.fit([train_data_padded, train_i_vectors_males],
    [train_labels_males],
...
np.save('../history/history_model_72_males.npy', history.history)
modelHistory = np.load('../history/history_model_72_males.npy').item()

print ("HISTORY: ")
print (modelHistory)

model_72.load_weights('/home/hpc_lkpiel/models/model_72_males.hdf5')

val_predictions = model_72.predict([val_data_padded, val_i_vectors_males])
print ("VAL PREDICTED")

test_predictions = model_72.predict([test_data_padded, test_i_vectors_males])
print ("TEST PREDICTED")




np.save('/home/hpc_lkpiel/predictions/val/model_72_males.npy', val_predictions)

print ("VAL SAVED")

np.save('/home/hpc_lkpiel/predictions/test/model_72_males.npy', test_predictions)
