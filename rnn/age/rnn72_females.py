...
checkpoint = ModelCheckpoint(filepath='/models/model_72_females.hdf5', monitor='val_acc', save_best_only=True)
...
print ("HISTORY: ")
print (modelHistory)
model_72.load_weights('/models/model_72_females.hdf5')
