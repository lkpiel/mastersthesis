...
checkpoint = ModelCheckpoint(filepath='/home/hpc_lkpiel/models/model_57.hdf5', monitor='val_acc', save_best_only=True)
'''

history = model_57.fit([train_data_padded, train_i_vectors],
...
np.save('../history/history_model_57.npy', history.history)
modelHistory = np.load('../history/history_model_57.npy').item()

print ("HISTORY: ")
print (modelHistory)
'''

model_57.load_weights('/home/hpc_lkpiel/models/model_57.hdf5')
...
np.save('/home/hpc_lkpiel/predictions/val/model_57_males_original.npy', val_predictions)
print ("VAL SAVED")

np.save('/home/hpc_lkpiel/predictions/test/model_57_males_original.npy', test_predictions)
print ("TEST SAVED")
'''
