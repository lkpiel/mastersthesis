...
checkpoint = ModelCheckpoint(filepath='/home/hpc_lkpiel/models/model_68_females.hdf5', monitor='val_acc', save_best_only=True)


history = model_68.fit([train_data_padded, train_i_vectors_females],
...
np.save('../history/history_model_68_females.npy', history.history)
modelHistory = np.load('../history/history_model_68_females.npy').item()
print ("HISTORY: ")
print (modelHistory)


model_68.load_weights('/home/hpc_lkpiel/models/model_68_females.hdf5')

val_predictions = model_68.predict([val_data_padded, val_i_vectors_females])
print ("VAL PREDICTED")

test_predictions = model_68.predict([test_data_padded, test_i_vectors_females])
print ("TEST PREDICTED")


np.save('/home/hpc_lkpiel/predictions/val/model_68_females.npy', val_predictions)
print ("VAL SAVED")

np.save('/home/hpc_lkpiel/predictions/test/model_68_females.npy', test_predictions)
print ("TEST SAVED")
'''
