...
print ("model_28 BUILT")

model_28.compile(loss='categorical_crossentropy', optimizer="adam", metrics=['accuracy'])
print ("model_28 COMPILED")


checkpoint = ModelCheckpoint(filepath='/home/hpc_lkpiel/models/model_28.hdf5', monitor='val_loss', save_best_only=True)

history = model_28.fit(x=train_data_padded,
...
np.save('../history/history_model_28.npy', history.history)
modelHistory = np.load('../history/history_model_28.npy').item()

print ("HISTORY: ")
print (modelHistory)
model_28.load_weights('/home/hpc_lkpiel/models/model_28.hdf5')

valResult = model_28.evaluate(val_data_padded, val_labels_age_group)
testResult = model_28.evaluate(test_data_padded, test_labels_age_group)

file = open("results.txt","a")
file.write("\nmodel_28 VAL: " + str(valResult) + " TEST: " + str(testResult))
file.close()
print ("WROTE TO FILE")
