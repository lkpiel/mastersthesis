...
print (model_77.summary)
print ("model_77 BUILT")

model_77.compile(loss='categorical_crossentropy', optimizer="adam", metrics=['accuracy'])
print ("model_77 COMPILED")


checkpoint = ModelCheckpoint(filepath='/home/hpc_lkpiel/models/model_77.hdf5', monitor='val_loss', save_best_only=True)
model_77.load_weights('/home/hpc_lkpiel/models/model_77.hdf5')
print ("WEIGHTS LOADED")
'''
history = model_77.fit(x=train_data_padded,
...
np.save('../history/history_model_77.npy', history.history)
modelHistory = np.load('../history/history_model_77.npy').item()

print ("HISTORY: ")
print (modelHistory)
model_77.load_weights('/home/hpc_lkpiel/models/model_77.hdf5')

valResult = model_77.evaluate(val_data_padded, val_labels_age_group)
testResult = model_77.evaluate(test_data_padded, test_labels_age_group)

file = open("results.txt","a")
file.write("\nmodel_77 VAL: " + str(valResult) + " TEST: " + str(testResult))
file.close()
print ("WROTE TO FILE")
'''

val_predictions = model_77.predict(val_data_padded)
print ("VAL PREDICTED")

test_predictions = model_77.predict(test_data_padded)
print ("TEST PREDICTED")

np.save('/home/hpc_lkpiel/predictions/val/model_77.npy', val_predictions)
print ("VAL SAVED")

np.save('/home/hpc_lkpiel/predictions/test/model_77.npy', test_predictions)
