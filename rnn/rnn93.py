...
input_layer = Input(shape=(1107, 20, 1))
...
model_93 = Model(inputs=input_layer, outputs=[output_layer_1, output_layer_2])

model_93.compile(loss={'gender_output':'categorical_crossentropy', 'age_output':'mse'},
                    optimizer=SGD(0.01),
                    metrics={'gender_output':'accuracy','age_output':age_group_accuracy})
print ("multi_model MODEL COMPILED")


checkpoint = ModelCheckpoint(filepath='/home/hpc_lkpiel/models/model_93.hdf5', monitor='val_age_output_age_group_accuracy', save_best_only=True)

'''
history = model_93.fit(x=train_data_padded,
...
np.save('../history/history_model_93.npy', history.history)
modelHistory = np.load('../history/history_model_93.npy').item()

print ("HISTORY: ")
print (modelHistory)
print (model_93.evaluate(val_data_padded, [val_labels_gender, val_labels_age]))
print (model_93.evaluate(test_data_padded, [test_labels_gender, test_labels_age]))
'''
model_93.load_weights('/home/hpc_lkpiel/models/model_93.hdf5')

val_predictions = model_93.predict(val_data_padded)
print ("VAL PREDICTED")

test_predictions = model_93.predict(test_data_padded)
print ("TEST PREDICTED")

np.save('/home/hpc_lkpiel/predictions/val/model_93_gender.npy', val_predictions[0])
print ("VAL SAVED")

np.save('/home/hpc_lkpiel/predictions/test/model_93_gender.npy', test_predictions[0])
print ("TEST SAVED")

np.save('/home/hpc_lkpiel/predictions/val/model_93_age_group.npy', val_predictions[1])
print ("VAL SAVED")

np.save('/home/hpc_lkpiel/predictions/test/model_93_age_group.npy', test_predictions[1])
print ("TEST SAVED")

'''
valResult = model_93.evaluate(val_data_padded, val_labels_age_group)
testResult = model_93.evaluate(test_data_padded, test_labels_age_group)

file = open("results.txt","a")
file.write("\nmodel_93 VAL: " + str(valResult) + " TEST: " + str(testResult))
file.close()
'''
print ("WROTE TO FILE model_93")
