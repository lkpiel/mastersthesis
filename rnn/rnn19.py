...
print ("model_19 BUILT")

model_19.compile(loss='categorical_crossentropy', optimizer='adam', metrics=['accuracy'])
print ("model_19 COMPILED")


checkpoint = ModelCheckpoint(filepath='/home/hpc_lkpiel/models/model_19.hdf5', monitor='val_acc', save_best_only=True)

history = model_19.fit(x=train_data_padded,
...
np.save('../history/history_model_19.npy', history.history)
modelHistory = np.load('../history/history_model_19.npy').item()

print ("HISTORY: ")
print (modelHistory)
model_19.load_weights('/home/hpc_lkpiel/models/model_19.hdf5')

valResult = model_19.evaluate(val_data_padded, val_labels_age_group)
testResult = model_19.evaluate(test_data_padded, test_labels_age_group)

file = open("results.txt","a")
file.write("\nmodel_19 VAL: " + str(valResult) + " TEST: " + str(testResult))
file.close()
print ("WROTE TO FILE")
