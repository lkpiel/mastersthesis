...
print (model_69.summary)
print ("model_69 BUILT")

model_69.compile(loss='categorical_crossentropy', optimizer="adam", metrics=['accuracy'])
print ("model_69 COMPILED")


checkpoint = ModelCheckpoint(filepath='/home/hpc_lkpiel/models/model_69.hdf5', monitor='val_acc', save_best_only=True)

history = model_69.fit(x=train_data_padded,
...
np.save('../history/history_model_69.npy', history.history)
modelHistory = np.load('../history/history_model_69.npy').item()

print ("HISTORY: ")
print (modelHistory)

model_69.load_weights('/home/hpc_lkpiel/models/model_69.hdf5')

val_predictions = model_69.predict(val_data_padded)
print ("VAL PREDICTED")

test_predictions = model_69.predict(test_data_padded)
print ("TEST PREDICTED")


np.save('/home/hpc_lkpiel/predictions/val/model_69.npy', val_predictions)
print ("VAL SAVED")

np.save('/home/hpc_lkpiel/predictions/test/model_69.npy', test_predictions)
print ("TEST SAVED")
valResult = model_69.evaluate(val_data_padded, val_labels_age_group)
testResult = model_69.evaluate(test_data_padded, test_labels_age_group)

file = open("results.txt","a")
file.write("\nmodel_69 VAL: " + str(valResult) + " TEST: " + str(testResult))
file.close()
print ("WROTE TO FILE model_69")
