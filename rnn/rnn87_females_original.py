...
'''
val_predictions = model_87.predict([val_data_padded, val_i_vectors_females])
print ("VAL PREDICTED")

test_predictions = model_87.predict([test_data_padded, test_i_vectors_females])
print ("TEST PREDICTED")




np.save('/home/hpc_lkpiel/predictions/val/model_87_females_original.npy', val_predictions[0])

print ("VAL SAVED")

np.save('/home/hpc_lkpiel/predictions/test/model_87_females_original.npy', test_predictions[0])
