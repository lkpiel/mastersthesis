...
print ("model_61 BUILT")

model_61.compile(loss='categorical_crossentropy', optimizer="adam", metrics=['accuracy'])
print ("model_61 COMPILED")


checkpoint = ModelCheckpoint(filepath='/home/hpc_lkpiel/models/model_61.hdf5', monitor='val_acc', save_best_only=True)
'''
history = model_61.fit(x=train_data_padded,
...
np.save('../history/history_model_61.npy', history.history)
modelHistory = np.load('../history/history_model_61.npy').item()

print ("HISTORY: ")
print (modelHistory)
'''
model_61.load_weights('/home/hpc_lkpiel/models/model_61.hdf5')

val_predictions = model_61.predict(val_data_padded)
print ("VAL PREDICTED")

test_predictions = model_61.predict(test_data_padded)
print ("TEST PREDICTED")

np.save('/home/hpc_lkpiel/predictions/val/model_61.npy', val_predictions)
print ("VAL SAVED")

np.save('/home/hpc_lkpiel/predictions/test/model_61.npy', test_predictions)
print ("TEST SAVED")
valResult = model_61.evaluate(val_data_padded, val_labels_age_group)
testResult = model_61.evaluate(test_data_padded, test_labels_age_group)

file = open("results.txt","a")
file.write("\nmodel_61 VAL: " + str(valResult) + " TEST: " + str(testResult))
file.close()
print ("WROTE TO FILE model_61")
