...
model_35 = Sequential([
    ...
    Conv2D(128, (5, 1), strides=(1, 1), activation='relu', border_mode='valid', kernel_regularizer=kernel_regularizer),
    Conv2D(128, (5, 1), strides=(3, 1), activation='relu', border_mode='valid', kernel_regularizer=kernel_regularizer),
    Conv2D(128, (5, 1), strides=(3, 1), activation='relu', border_mode='valid', kernel_regularizer=kernel_regularizer),
    Conv2D(128, (5, 1), strides=(3, 1), activation='relu', border_mode='valid', kernel_regularizer=kernel_regularizer),
...
print ("model_35 BUILT")

model_35.compile(loss='categorical_crossentropy', optimizer="adam", metrics=['accuracy'])
print ("model_35 COMPILED")


checkpoint = ModelCheckpoint(filepath='/home/hpc_lkpiel/models/model_35.hdf5', monitor='val_loss', save_best_only=True)

history = model_35.fit(x=train_data_padded,
...
np.save('../history/history_model_35.npy', history.history)
modelHistory = np.load('../history/history_model_35.npy').item()

print ("HISTORY: ")
print (modelHistory)
model_35.load_weights('/home/hpc_lkpiel/models/model_35.hdf5')

valResult = model_35.evaluate(val_data_padded, val_labels_age_group)
testResult = model_35.evaluate(test_data_padded, test_labels_age_group)

file = open("results.txt","a")
file.write("\nmodel_35 VAL: " + str(valResult) + " TEST: " + str(testResult))
file.close()
print ("WROTE TO FILE model_35")
