...
input_layer = Input(shape=(1107, 20), name="lstm_input")
...
print ("model_58 BUILT")
model_58 = Model(inputs=[input_layer, input_layer_2], outputs=output_layer_1)

model_58.compile(loss='categorical_crossentropy',
                    optimizer=SGD(0.01),
                    metrics=['accuracy'])

print ("model_58 COMPILED")


checkpoint = ModelCheckpoint(filepath='/home/hpc_lkpiel/models/model_58_con.hdf5', monitor='val_acc', save_best_only=True)
model_58.load_weights('/home/hpc_lkpiel/models/model_58.hdf5')


history = model_58.fit([train_data_padded, train_i_vectors],
...
np.save('../history/history_model_58_con.npy', history.history)
modelHistory = np.load('../history/history_model_58_con.npy').item()

print ("HISTORY: ")
print (modelHistory)

model_58.load_weights('/home/hpc_lkpiel/models/model_58_con.hdf5')


val_predictions = model_58.predict([val_data_padded, val_i_vectors])
print ("VAL PREDICTED")

test_predictions = model_58.predict([test_data_padded, test_i_vectors])
print ("TEST PREDICTED")


np.save('/home/hpc_lkpiel/predictions/val/model_58.npy', val_predictions)
print ("VAL SAVED")

np.save('/home/hpc_lkpiel/predictions/test/model_58.npy', test_predictions)
print ("TEST SAVED")

valResult = model_58.evaluate([val_data_padded, val_i_vectors], val_labels_age_group)
testResult = model_58.evaluate([test_data_padded, test_i_vectors], test_labels_age_group)

file = open("results.txt","a")
file.write("\nmodel_58 VAL: " + str(valResult) + " TEST: " + str(testResult))
file.close()
print ("WROTE TO FILE model_58")
