...
print ("model_15 BUILT")

model_15.compile(loss='categorical_crossentropy', optimizer='adam', metrics=['accuracy'])
print ("model_15 COMPILED")


checkpoint = ModelCheckpoint(filepath='/home/hpc_lkpiel/models/model_15.hdf5', monitor='val_loss', save_best_only=True)

history = model_15.fit(x=train_data_padded,
...
np.save('../history/history_model_15.npy', history.history)
modelHistory = np.load('../history/history_model_15.npy').item()

print ("HISTORY: ")
print (modelHistory)
model_15.load_weights('/home/hpc_lkpiel/models/model_15.hdf5')

valResult = model_15.evaluate(val_data_padded, val_labels_age_group)
testResult = model_15.evaluate(test_data_padded, test_labels_age_group)

file = open("results.txt","a")
file.write("\nmodel_15 VAL: " + str(valResult) + " TEST: " + str(testResult))
file.close()
print ("WROTE TO FILE")
