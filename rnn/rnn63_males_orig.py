...
print ("model_63 COMPILED")


checkpoint = ModelCheckpoint(filepath='/home/hpc_lkpiel/models/model_63.hdf5', monitor='val_acc', save_best_only=True)
'''

history = model_63.fit([train_data_padded, train_i_vectors],
...
np.save('../history/history_model_63.npy', history.history)
modelHistory = np.load('../history/history_model_63.npy').item()
...
val_predictions = model_63.predict([val_data_padded, val_data_i_vectors])
print ("VAL PREDICTED")

test_predictions = model_63.predict([test_data_padded, test_data_i_vectors])
print ("TEST PREDICTED")


np.save('/home/hpc_lkpiel/predictions/val/model_63_males_original.npy', val_predictions)
print ("VAL SAVED")

np.save('/home/hpc_lkpiel/predictions/test/model_63_males_original.npy', test_predictions)

valResult = model_63.evaluate([val_data_padded, val_data_i_vectors], val_labels_age_group)
testResult = model_63.evaluate([test_data_padded, test_data_i_vectors], test_labels_age_group)

file = open("results.txt","a")
file.write("\nmodel_63 VAL: " + str(valResult) + " TEST: " + str(testResult))
file.close()
print ("WROTE TO FILE model_63")
