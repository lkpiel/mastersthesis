...
print ("model_20 BUILT")

model_20.compile(loss='categorical_crossentropy', optimizer='adam', metrics=['accuracy'])
print ("model_20 COMPILED")


checkpoint = ModelCheckpoint(filepath='/home/hpc_lkpiel/models/model_20.hdf5', monitor='val_acc', save_best_only=True)

history = model_20.fit(x=train_data_padded,
...
np.save('../history/history_model_20.npy', history.history)
modelHistory = np.load('../history/history_model_20.npy').item()

print ("HISTORY: ")
print (modelHistory)
model_20.load_weights('/home/hpc_lkpiel/models/model_20.hdf5')

valResult = model_20.evaluate(val_data_padded, val_labels_age_group)
testResult = model_20.evaluate(test_data_padded, test_labels_age_group)

file = open("results.txt","a")
file.write("\nmodel_20 VAL: " + str(valResult) + " TEST: " + str(testResult))
file.close()
print ("WROTE TO FILE")
