...
val_predictions = model_86.predict([val_data_padded, val_i_vectors])
print ("VAL PREDICTED")

test_predictions = model_86.predict([test_data_padded, test_i_vectors])
print ("TEST PREDICTED")




np.save('/home/hpc_lkpiel/predictions/val/model_86.npy', val_predictions)

print ("VAL SAVED")

np.save('/home/hpc_lkpiel/predictions/test/model_86.npy', test_predictions)
