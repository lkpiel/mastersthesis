...
print ("model_56 BUILT")
model_56 = Model(inputs=[input_layer, input_layer_2], outputs=output_layer_1)

model_56.compile(loss='categorical_crossentropy',
                    optimizer=SGD(0.01),
                    metrics=['accuracy'])

print ("model_56 COMPILED")


checkpoint = ModelCheckpoint(filepath='/home/hpc_lkpiel/models/model_56.hdf5', monitor='val_acc', save_best_only=True)
'''

history = model_56.fit([train_data_padded, train_i_vectors],
...
np.save('../history/history_model_56.npy', history.history)
modelHistory = np.load('../history/history_model_56.npy').item()

print ("HISTORY: ")
print (modelHistory)
'''
model_56.load_weights('/home/hpc_lkpiel/models/model_56.hdf5')


val_predictions = model_56.predict([val_data_padded, val_i_vectors_males])
print ("VAL PREDICTED")

test_predictions = model_56.predict([test_data_padded, test_i_vectors_males])
print ("TEST PREDICTED")




np.save('/home/hpc_lkpiel/predictions/val/model_56_males_original.npy', val_predictions)

print ("VAL SAVED")

np.save('/home/hpc_lkpiel/predictions/test/model_56_males_original.npy', test_predictions)

print ("TEST SAVED")
'''
valResult = model_56.evaluate([val_data_padded, val_i_vectors], val_labels_age_group)
testResult = model_56.evaluate([test_data_padded, test_i_vectors], test_labels_age_group)

file = open("results.txt","a")
file.write("\nmodel_56 VAL: " + str(valResult) + " TEST: " + str(testResult))
file.close()
print ("WROTE TO FILE model_56")
'''
