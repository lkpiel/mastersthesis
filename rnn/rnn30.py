...
print ("model_30 BUILT")

model_30.compile(loss='categorical_crossentropy', optimizer="adam", metrics=['accuracy'])
print ("model_30 COMPILED")


checkpoint = ModelCheckpoint(filepath='/home/hpc_lkpiel/models/model_30.hdf5', monitor='val_loss', save_best_only=True)

history = model_30.fit(x=train_data_padded,
...
np.save('../history/history_model_30.npy', history.history)
modelHistory = np.load('../history/history_model_30.npy').item()

print ("HISTORY: ")
print (modelHistory)
model_30.load_weights('/home/hpc_lkpiel/models/model_30.hdf5')

valResult = model_30.evaluate(val_data_padded, val_labels_age_group)
testResult = model_30.evaluate(test_data_padded, test_labels_age_group)

file = open("results.txt","a")
file.write("\nmodel_30 VAL: " + str(valResult) + " TEST: " + str(testResult))
file.close()
print ("WROTE TO FILE model_30")
