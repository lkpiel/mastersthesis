...
output_layer_2 =  Dense(2, activation='softmax', name='gender')(z)

print ("model_87 BUILT")
model_87 = Model(inputs=[input_layer, input_layer_2], outputs=[output_layer_1, output_layer_2])

model_87.compile(loss={'group_output':'categorical_crossentropy', 'gender':'categorical_crossentropy'},
                    optimizer=SGD(0.01),
...
history = model_87.fit([train_data_padded, train_i_vectors],
    [train_labels_age_group, train_labels_gender],
    validation_data=([val_data_padded, val_i_vectors], [val_labels_age_group, val_labels_gender]),
    epochs=30,
    verbose=1,
    batch_size=64,
...
np.save('../history/history_model_87_gender.npy', history.history)

modelHistory = np.load('../history/history_model_87_gender.npy').item()
...
print ("WROTE TO FILE model_87")

'''
val_predictions = model_87.predict([val_data_padded, val_i_vectors_males])
print ("VAL PREDICTED")

test_predictions = model_87.predict([test_data_padded, test_i_vectors_males])
print ("TEST PREDICTED")




np.save('/home/hpc_lkpiel/predictions/val/model_87_males_original.npy', val_predictions[0])

print ("VAL SAVED")

np.save('/home/hpc_lkpiel/predictions/test/model_87_males_original.npy', test_predictions[0])
