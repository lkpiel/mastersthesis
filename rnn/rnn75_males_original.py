...
np.save('/home/hpc_lkpiel/predictions/val/model_75_males_original.npy', val_predictions)
print ("VAL SAVED")

np.save('/home/hpc_lkpiel/predictions/test/model_75_males_original.npy', test_predictions)
print ("TEST SAVED")
'''
