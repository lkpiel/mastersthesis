...
print (model_71.summary)
print ("model_71 BUILT")

model_71.compile(loss='categorical_crossentropy', optimizer="adam", metrics=['accuracy'])
print ("model_71 COMPILED")


checkpoint = ModelCheckpoint(filepath='/home/hpc_lkpiel/models/model_71.hdf5', monitor='val_acc', save_best_only=True)
'''
history = model_71.fit(x=train_data_padded,
...
np.save('../history/history_model_71.npy', history.history)
modelHistory = np.load('../history/history_model_71.npy').item()

print ("HISTORY: ")
print (modelHistory)
'''
model_71.load_weights('/home/hpc_lkpiel/models/model_71.hdf5')


val_predictions = model_71.predict(val_data_padded)
print ("VAL PREDICTED")

test_predictions = model_71.predict(test_data_padded)
print ("TEST PREDICTED")


np.save('/home/hpc_lkpiel/predictions/val/model_71.npy', val_predictions)
print ("VAL SAVED")

np.save('/home/hpc_lkpiel/predictions/test/model_71.npy', test_predictions)
print ("TEST SAVED")


valResult = model_71.evaluate(val_data_padded, val_labels_age_group)
testResult = model_71.evaluate(test_data_padded, test_labels_age_group)

file = open("results.txt","a")
file.write("\nmodel_71 VAL: " + str(valResult) + " TEST: " + str(testResult))
file.close()
print ("WROTE TO FILE model_71")
