...
checkpoint = ModelCheckpoint(filepath='/home/hpc_lkpiel/models/model_29.hdf5', monitor='val_loss', save_best_only=True)

history = model_29.fit(x=train_data_padded,
...
np.save('../history/history_model_29.npy', history.history)
modelHistory = np.load('../history/history_model_29.npy').item()

print ("HISTORY: ")
print (modelHistory)
model_29.load_weights('/home/hpc_lkpiel/models/model_29.hdf5')

valResult = model_29.evaluate(val_data_padded, val_labels_age_group)
testResult = model_29.evaluate(test_data_padded, test_labels_age_group)

file = open("results.txt","a")
file.write("\nmodel_29 VAL: " + str(valResult) + " TEST: " + str(testResult))
file.close()
print ("WROTE TO FILE")
