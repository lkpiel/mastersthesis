...
np.save('../history/history_model_43.npy', history.history)
modelHistory = np.load('../history/history_model_43.npy').item()
...
np.save('/home/hpc_lkpiel/predictions/val/model_43_males_original.npy', val_predictions)
print ("VAL SAVED")

np.save('/home/hpc_lkpiel/predictions/test/model_43_males_original.npy', test_predictions)
print ("TEST SAVED")
'''
