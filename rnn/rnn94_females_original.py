...
np.save('/home/hpc_lkpiel/predictions/val/model_94_females_original_age_group.npy', val_predictions[1])
print ("VAL SAVED")

np.save('/home/hpc_lkpiel/predictions/test/model_94_females_original_age_group.npy', test_predictions[1])
print ("TEST SAVED")
