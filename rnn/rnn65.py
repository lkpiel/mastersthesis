...
print (model_65.evaluate(val_data_padded, val_labels_age_group))
...
np.save('/home/hpc_lkpiel/predictions/val/model_65.npy', val_predictions)
print ("VAL SAVED")

np.save('/home/hpc_lkpiel/predictions/test/model_65.npy', test_predictions)
print ("TEST SAVED")
