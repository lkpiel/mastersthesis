...
train_labels_age_group = onehot(train_data_i_vectors[train_data_i_vectors['Gender'] == 1]['AgeGroup'])
...
val_labels_age_group = onehot(val_data_i_vectors[val_data_i_vectors['Gender'] == 1]['AgeGroup'])
...
test_labels_age_group = onehot(test_data_i_vectors[test_data_i_vectors['Gender'] == 1]['AgeGroup'])
...
kernel_initializerr=keras.initializers.RandomNormal(mean=0.0, stddev=0.05, seed=None)


model_77_females = Sequential([
...
print (model_77_females.summary)
print ("model_77_females BUILT")

model_77_females.compile(loss='categorical_crossentropy', optimizer="adam", metrics=['accuracy'])
print ("model_77_females COMPILED")


checkpoint = ModelCheckpoint(filepath='/home/hpc_lkpiel/models/model_77_females.hdf5', monitor='val_loss', save_best_only=True)
print ("WEIGHTS LOADED")

history = model_77_females.fit(x=train_data_padded,
...
np.save('../history/history_model_77_females.npy', history.history)
modelHistory = np.load('../history/history_model_77_females.npy').item()

print ("HISTORY: ")
print (modelHistory)
model_77_females.load_weights('/home/hpc_lkpiel/models/model_77_females.hdf5')

valResult = model_77_females.evaluate(val_data_padded, val_labels_age_group)
testResult = model_77_females.evaluate(test_data_padded, test_labels_age_group)

file = open("results.txt","a")
file.write("\nmodel_77_females VAL: " + str(valResult) + " TEST: " + str(testResult))
file.close()
print ("WROTE TO FILE")


val_predictions = model_77_females.predict(val_data_padded)
print ("VAL PREDICTED")

test_predictions = model_77_females.predict(test_data_padded)
print ("TEST PREDICTED")

np.save('/home/hpc_lkpiel/predictions/val/model_77_females.npy', val_predictions)
print ("VAL SAVED")

np.save('/home/hpc_lkpiel/predictions/test/model_77_females.npy', test_predictions)
