...
checkpoint = ModelCheckpoint(filepath='/models/model_77_females.hdf5', monitor='val_loss', save_best_only=True)
...
print ("HISTORY: ")
print (modelHistory)
model_77_females.load_weights('/models/model_77_females.hdf5')
