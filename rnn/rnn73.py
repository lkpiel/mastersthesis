...
print (model_73.summary)
print ("model_73 BUILT")

model_73.compile(loss='categorical_crossentropy', optimizer="adam", metrics=['accuracy'])
print ("model_73 COMPILED")


checkpoint = ModelCheckpoint(filepath='/home/hpc_lkpiel/models/model_73.hdf5', monitor='val_acc', save_best_only=True)
model_73.load_weights('/home/hpc_lkpiel/models/model_69.hdf5')
'''
history = model_73.fit(x=train_data_padded,
...
np.save('../history/history_model_73.npy', history.history)
modelHistory = np.load('../history/history_model_73.npy').item()

print ("HISTORY: ")
print (modelHistory)
'''
model_73.load_weights('/home/hpc_lkpiel/models/model_73.hdf5')


val_predictions = model_73.predict(val_data_padded)
print ("VAL PREDICTED")

test_predictions = model_73.predict(test_data_padded)
print ("TEST PREDICTED")


np.save('/home/hpc_lkpiel/predictions/val/model_73.npy', val_predictions)
print ("VAL SAVED")

np.save('/home/hpc_lkpiel/predictions/test/model_73.npy', test_predictions)
valResult = model_73.evaluate(val_data_padded, val_labels_age_group)
testResult = model_73.evaluate(test_data_padded, test_labels_age_group)

file = open("results.txt","a")
file.write("\nmodel_73 VAL: " + str(valResult) + " TEST: " + str(testResult))
file.close()
print ("WROTE TO FILE model_73")
