...
checkpoint = ModelCheckpoint(filepath='/models/model_73.hdf5', monitor='val_acc', save_best_only=True)
model_73.load_weights('/models/model_69.hdf5')
'''
...
print (modelHistory)
'''
model_73.load_weights('/models/model_73.hdf5')
