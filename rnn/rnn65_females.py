...
train_labels_age_group_females = onehot(train_data_i_vectors[train_data_i_vectors['Gender'] == 1]['AgeGroup'])
...
train_labels_age_group_females = np.load("../dnn/dnn_predicted_labels.npy")[np.array(trainFemaleIndexes)]
...
val_labels_age_group_females = onehot(val_data_i_vectors[val_data_i_vectors['Gender'] == 1]['AgeGroup'])
...
test_labels_age_group_females = onehot(test_data_i_vectors[test_data_i_vectors['Gender'] == 1]['AgeGroup'])
...
print (model_65_females.summary)
print ("model_65_females BUILT")

model_65_females.compile(loss='categorical_crossentropy', optimizer="adam", metrics=['accuracy'])
print ("model_65_females COMPILED")


checkpoint = ModelCheckpoint(filepath='/home/hpc_lkpiel/models/model_65_females.hdf5', monitor='val_acc', save_best_only=True)

history = model_65_females.fit(x=train_data_padded,
        y=train_labels_age_group_females,
        validation_data=(val_data_padded, val_labels_age_group_females),
        epochs=40,
        verbose=1,
        batch_size=128,
...
np.save('../history/history_model_65_females.npy', history.history)
modelHistory = np.load('../history/history_model_65_females.npy').item()

print ("HISTORY: ")
print (modelHistory)


model_65_females.load_weights('/home/hpc_lkpiel/models/model_65_females.hdf5')

val_predictions = model_65_females.predict(val_data_padded)
print ("VAL PREDICTED")

test_predictions = model_65_females.predict(test_data_padded)
print ("TEST PREDICTED")

np.save('/home/hpc_lkpiel/predictions/val/model_65_females.npy', val_predictions)
print ("VAL SAVED")

np.save('/home/hpc_lkpiel/predictions/test/model_65_females.npy', test_predictions)
print ("TEST SAVED")
