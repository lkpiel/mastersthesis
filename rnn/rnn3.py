...
print ("model_3 COMPILED")


checkpoint = ModelCheckpoint(filepath='/home/hpc_lkpiel/models/model_3.hdf5', monitor='val_loss', save_best_only=True)

history = model_3.fit(x=train_data_padded,
...
np.save('../history/history_model_3.npy', history.history)
modelHistory = np.load('../history/history_model_3.npy').item()

print ("HISTORY: ")
print (modelHistory)
model_3.load_weights('/home/hpc_lkpiel/models/model_3.hdf5')

valResult = model_3.evaluate(val_data_padded, val_labels_age_group)
testResult = model_3.evaluate(test_data_padded, test_labels_age_group)

file = open("results.txt","a")
file.write("\nmodel_3 VAL: " + str(valResult) + " TEST: " + str(testResult))
file.close()
print ("WROTE TO FILE")
