...
model_27 = Sequential([
    ...
    Conv2D(128, (5, 1),  activation='relu', kernel_regularizer=kernel_regularizer, border_mode='valid'),
...
print ("model_27 BUILT")

model_27.compile(loss='categorical_crossentropy', optimizer="adam", metrics=['accuracy'])
print ("model_27 COMPILED")


checkpoint = ModelCheckpoint(filepath='/home/hpc_lkpiel/models/model_27.hdf5', monitor='val_loss', save_best_only=True)

history = model_27.fit(x=train_data_padded,
...
np.save('../history/history_model_27.npy', history.history)
modelHistory = np.load('../history/history_model_27.npy').item()

print ("HISTORY: ")
print (modelHistory)
model_27.load_weights('/home/hpc_lkpiel/models/model_27.hdf5')

valResult = model_27.evaluate(val_data_padded, val_labels_age_group)
testResult = model_27.evaluate(test_data_padded, test_labels_age_group)

file = open("results.txt","a")
file.write("\nmodel_27 VAL: " + str(valResult) + " TEST: " + str(testResult))
file.close()
print ("WROTE TO FILE")
