...
model_38 = Sequential([
    ...
    Reshape((-1, 128)),
    Bidirectional(LSTM(256, return_sequences=True, kernel_constraint=max_norm(max_value=2, axis=0))),
    AttentionWithContext(),
    Dense(3, activation='softmax')
])

print (model_38.summary)
print ("model_38 BUILT")

model_38.compile(loss='categorical_crossentropy', optimizer="adam", metrics=['accuracy'])
print ("model_38 COMPILED")


checkpoint = ModelCheckpoint(filepath='/home/hpc_lkpiel/models/model_38.hdf5', monitor='val_acc', save_best_only=True)
history = model_38.fit(x=train_data_padded,
...
np.save('../history/history_model_38.npy', history.history)
modelHistory = np.load('../history/history_model_38.npy').item()

print ("HISTORY: ")
print (modelHistory)


model_38.load_weights('/home/hpc_lkpiel/models/model_38.hdf5')


val_predictions = model_38.predict(val_data_padded)
print ("VAL PREDICTED")

test_predictions = model_38.predict(test_data_padded)
print ("TEST PREDICTED")


np.save('/home/hpc_lkpiel/predictions/val/model_38.npy', val_predictions)
print ("VAL SAVED")

np.save('/home/hpc_lkpiel/predictions/test/model_38.npy', test_predictions)
print ("TEST SAVED")

valResult = model_38.evaluate(val_data_padded, val_labels_age_group)
testResult = model_38.evaluate(test_data_padded, test_labels_age_group)

file = open("results.txt","a")
file.write("\nmodel_38 VAL: " + str(valResult) + " TEST: " + str(testResult))
file.close()
print ("WROTE TO FILE model_38")
