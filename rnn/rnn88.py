...
np.save('/home/hpc_lkpiel/predictions/val/model_88_age_group.npy', val_predictions[0])
print ("VAL SAVED")

np.save('/home/hpc_lkpiel/predictions/test/model_88_age_group.npy', test_predictions[0])
print ("TEST SAVED")
