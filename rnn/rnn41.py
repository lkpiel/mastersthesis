...
print (model_41.summary)
print ("model_41 BUILT")

model_41.compile(loss='categorical_crossentropy', optimizer="adam", metrics=['accuracy'])
print ("model_41 COMPILED")


checkpoint = ModelCheckpoint(filepath='/home/hpc_lkpiel/models/model_41.hdf5', monitor='val_acc', save_best_only=True)
'''
history = model_41.fit(x=train_data_padded,
...
np.save('../history/history_model_41.npy', history.history)
modelHistory = np.load('../history/history_model_41.npy').item()

print ("HISTORY: ")
print (modelHistory)
'''
model_41.load_weights('/home/hpc_lkpiel/models/model_41.hdf5')


val_predictions = model_41.predict(val_data_padded)
print ("VAL PREDICTED")

test_predictions = model_41.predict(test_data_padded)
print ("TEST PREDICTED")

np.save('/home/hpc_lkpiel/predictions/val/model_41.npy', val_predictions)
print ("VAL SAVED")

np.save('/home/hpc_lkpiel/predictions/test/model_41.npy', test_predictions)
print ("TEST SAVED")
'''
valResult = model_41.evaluate(val_data_padded, val_labels_age_group)
testResult = model_41.evaluate(test_data_padded, test_labels_age_group)

file = open("results.txt","a")
file.write("\nmodel_41 VAL: " + str(valResult) + " TEST: " + str(testResult))
file.close()
'''
print ("WROTE TO FILE model_41")
