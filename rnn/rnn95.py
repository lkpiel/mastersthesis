...
output_layer_1 = Dense(1, activation='softmax')(z)

print ("model_95 BUILT")
model_95 = Model(inputs=[input_layer, input_layer_2], outputs=output_layer_1)

model_95.compile(loss='mse',
                    optimizer="adam",
                    metrics=[age_group_accuracy])

print ("model_95 COMPILED")


checkpoint = ModelCheckpoint(filepath='/home/hpc_lkpiel/models/model_95.hdf5', monitor='val_age_group_accuracy', save_best_only=True)


history = model_95.fit([train_data_padded, train_i_vectors],
    [train_labels_age],
    validation_data=([val_data_padded, val_i_vectors], [val_labels_age]),
    epochs=40,
    verbose=1,
    batch_size=128,
...
np.save('../../history/history_model_95.npy', history.history)
modelHistory = np.load('../../history/history_model_95.npy').item()

print ("HISTORY: ")
print (modelHistory)

model_95.load_weights('/home/hpc_lkpiel/models/model_95.hdf5')


val_predictions = model_95.predict([val_data_padded, val_i_vectors])
print ("VAL PREDICTED")

test_predictions = model_95.predict([test_data_padded, test_i_vectors])
print ("TEST PREDICTED")


np.save('/home/hpc_lkpiel/predictions/val/model_95.npy', val_predictions)
print ("VAL SAVED")

np.save('/home/hpc_lkpiel/predictions/test/model_95.npy', test_predictions)

valResult = model_95.evaluate([val_data_padded, val_i_vectors], val_labels_age)
testResult = model_95.evaluate([test_data_padded, test_i_vectors], test_labels_age)

file = open("results.txt","a")
file.write("\nmodel_95 VAL: " + str(valResult) + " TEST: " + str(testResult))
file.close()
print ("WROTE TO FILE model_95")
