...
print ("model_89 BUILT")
model_89 = Model(inputs=[input_layer, input_layer_2], outputs=output_layer_1)

model_89.compile(loss='mse',
                    optimizer=SGD(0.01),
...
np.save('../history/history_model_89.npy', history.history)
modelHistory = np.load('../history/history_model_89.npy').item()
