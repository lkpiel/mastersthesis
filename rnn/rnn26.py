...
model_26 = Sequential([
    Conv2D(512, (3, 20), activation='relu', border_mode='valid', input_shape=(1107, 20, 1)),
...
print ("model_26 BUILT")

model_26.compile(loss='categorical_crossentropy', optimizer="adam", metrics=['accuracy'])
print ("model_26 COMPILED")


checkpoint = ModelCheckpoint(filepath='/home/hpc_lkpiel/models/model_26.hdf5', monitor='val_acc', save_best_only=True)

history = model_26.fit(x=train_data_padded,
...
np.save('../history/history_model_26.npy', history.history)
modelHistory = np.load('../history/history_model_26.npy').item()

print ("HISTORY: ")
print (modelHistory)

model_26.load_weights('/home/hpc_lkpiel/models/model_26.hdf5')


val_predictions = model_26.predict(val_data_padded)
print ("VAL PREDICTED")

test_predictions = model_26.predict(test_data_padded)
print ("TEST PREDICTED")


np.save('/home/hpc_lkpiel/predictions/val/model_26.npy', val_predictions)
print ("VAL SAVED")

np.save('/home/hpc_lkpiel/predictions/test/model_26.npy', test_predictions)
print ("TEST SAVED")

'''
valResult = model_26.evaluate(val_data_padded, val_labels_age_group)
testResult = model_26.evaluate(test_data_padded, test_labels_age_group)

file = open("results.txt","a")
file.write("\nmodel_26 VAL: " + str(valResult) + " TEST: " + str(testResult))
file.close()
print ("WROTE TO FILE")
'''
########################################