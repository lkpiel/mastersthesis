...
print ("model_16 BUILT")

model_16.compile(loss='categorical_crossentropy', optimizer='adam', metrics=['accuracy'])
print ("model_16 COMPILED")


checkpoint = ModelCheckpoint(filepath='/home/hpc_lkpiel/models/model_16.hdf5', monitor='val_loss', save_best_only=True)

history = model_16.fit(x=train_data_padded,
...
np.save('../history/history_model_16.npy', history.history)
modelHistory = np.load('../history/history_model_16.npy').item()

print ("HISTORY: ")
print (modelHistory)
model_16.load_weights('/home/hpc_lkpiel/models/model_16.hdf5')

valResult = model_16.evaluate(val_data_padded, val_labels_age_group)
testResult = model_16.evaluate(test_data_padded, test_labels_age_group)

file = open("results.txt","a")
file.write("\nmodel_16 VAL: " + str(valResult) + " TEST: " + str(testResult))
file.close()
print ("WROTE TO FILE")
