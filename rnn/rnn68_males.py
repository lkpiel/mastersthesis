...
np.save('../history/history_model_68_males.npy', history.history)
modelHistory = np.load('../history/history_model_68_males.npy').item()
print ("HISTORY: ")
print (modelHistory)
...
np.save('/home/hpc_lkpiel/predictions/val/model_68_males.npy', val_predictions)
print ("VAL SAVED")

np.save('/home/hpc_lkpiel/predictions/test/model_68_males.npy', test_predictions)
print ("TEST SAVED")
'''
