...
model_87.load_weights('/home/hpc_lkpiel/models/model_87_gender.hdf5')
...
val_predictions = model_87.predict([val_data_padded, val_i_vectors])
print ("VAL PREDICTED")

test_predictions = model_87.predict([test_data_padded, test_i_vectors])
print ("TEST PREDICTED")




np.save('/home/hpc_lkpiel/predictions/val/model_87_gender.npy', val_predictions[1])

print ("VAL SAVED")

np.save('/home/hpc_lkpiel/predictions/test/model_87_gender.npy', test_predictions[1])
