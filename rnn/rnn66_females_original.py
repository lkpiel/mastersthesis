...
np.save('/home/hpc_lkpiel/predictions/val/model_66_females_original.npy', val_predictions)
print ("VAL SAVED")

np.save('/home/hpc_lkpiel/predictions/test/model_66_females_original.npy', test_predictions)
'''
