...
train_labels_age_group = train_labels_age_group[np.array(trainMaleIndexes)]
...
checkpoint = ModelCheckpoint(filepath='/home/hpc_lkpiel/models/model_43_males.hdf5', monitor='val_acc', save_best_only=True)

history = model_43.fit(x=train_data_padded,
        y=train_labels_age_group,
        validation_data=(val_data_padded, val_labels_males),
        epochs=50,
        verbose=1,
        batch_size=64,
...
np.save('../history/history_model_43_males.npy', history.history)
modelHistory = np.load('../history/history_model_43_males.npy').item()

print ("HISTORY: ")
print (modelHistory)


model_43.load_weights('/home/hpc_lkpiel/models/model_43_males.hdf5')
...
np.save('/home/hpc_lkpiel/predictions/val/model_43_males.npy', val_predictions)
print ("VAL SAVED")

np.save('/home/hpc_lkpiel/predictions/test/model_43_males.npy', test_predictions)
print ("TEST SAVED")
'''
