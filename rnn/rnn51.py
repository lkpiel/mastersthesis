...
print ("model_51 BUILT")

model_51.compile(loss='mse', optimizer=SGD(0.01), metrics=[age_group_accuracy])
print ("model_51 COMPILED")

checkpoint = ModelCheckpoint(filepath='/home/hpc_lkpiel/models/model_51.hdf5', monitor='val_age_group_accuracy', save_best_only=True)
model_51.load_weights('/home/hpc_lkpiel/models/model_47.hdf5')
'''
history = model_51.fit(x=train_data_padded,
        y=train_labels_age,
...
np.save('../history/history_model_51.npy', history.history)
modelHistory = np.load('../history/history_model_51.npy').item()

print ("HISTORY: ")
print (modelHistory)
'''
model_51.load_weights('/home/hpc_lkpiel/models/model_51.hdf5')

val_predictions = model_51.predict(val_data_padded)
print ("VAL PREDICTED")

test_predictions = model_51.predict(test_data_padded)
print ("TEST PREDICTED")


np.save('/home/hpc_lkpiel/predictions/val/model_51.npy', val_predictions)
print ("VAL SAVED")

np.save('/home/hpc_lkpiel/predictions/test/model_51.npy', test_predictions)
print ("TEST SAVED")
print ("WROTE TO FILE model_51")
