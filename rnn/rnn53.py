...
train_labels_gender = train_data_i_vectors['Gender']
val_labels_gender = val_data_i_vectors['Gender']
test_labels_gender = test_data_i_vectors['Gender']
print ("LABELS LOADED")
...
print ("model_53 BUILT")
model_53 = Model(inputs=input_layer, outputs=[output_layer_1, output_layer_2])

model_53.compile(loss={'group_output':'categorical_crossentropy', 'age_output':'mse'},
                    optimizer=SGD(0.01),
                    metrics={'group_output':'accuracy','age_output':age_group_accuracy})

print ("model_53 COMPILED")


checkpoint = ModelCheckpoint(filepath='/home/hpc_lkpiel/models/model_53.hdf5', monitor='val_group_output_acc', save_best_only=True)


history = model_53.fit(train_data_padded,
    [train_labels_age_group, train_labels_age],
    validation_data=(val_data_padded, [val_labels_age_group, val_labels_age]),
    epochs=40,
    verbose=1,
    batch_size=128,
...
np.save('../history/history_model_53.npy', history.history)
modelHistory = np.load('../history/history_model_53.npy').item()

print ("HISTORY: ")
print (modelHistory)

model_53.load_weights('/home/hpc_lkpiel/models/model_53.hdf5')

val_predictions = model_53.predict(val_data_padded)
print ("VAL PREDICTED")

test_predictions = model_53.predict(test_data_padded)
print ("TEST PREDICTED")


np.save('/home/hpc_lkpiel/predictions/val/model_53_age_group.npy', val_predictions[0])
print ("VAL SAVED")

np.save('/home/hpc_lkpiel/predictions/test/model_53_age_group.npy', test_predictions[0])
print ("TEST SAVED")

np.save('/home/hpc_lkpiel/predictions/val/model_53_age.npy', val_predictions[1])
print ("VAL SAVED")

np.save('/home/hpc_lkpiel/predictions/test/model_53_age.npy', test_predictions[1])
print ("TEST SAVED")

file = open("results.txt","a")
file.write("\nmodel_53 VAL: " + str(valResult) + " TEST: " + str(testResult))
file.close()
print ("WROTE TO FILE model_53")
