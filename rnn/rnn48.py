...
print ("model_48 BUILT")

model_48.compile(loss='mse', optimizer=SGD(0.01), metrics=[age_group_accuracy])
print ("model_48 COMPILED")

checkpoint = ModelCheckpoint(filepath='/home/hpc_lkpiel/models/model_48.hdf5', monitor='val_age_group_accuracy', save_best_only=True)
model_48.load_weights('/home/hpc_lkpiel/models/model_48.hdf5')
'''
history = model_48.fit(x=train_data_padded,
        y=train_labels_age,
...
np.save('../history/history_model_48.npy', history.history)
modelHistory = np.load('../history/history_model_48.npy').item()
...
val_predictions = model_48.predict(val_data_padded)
print ("VAL PREDICTED")

test_predictions = model_48.predict(test_data_padded)
print ("TEST PREDICTED")


np.save('/home/hpc_lkpiel/predictions/val/model_48.npy', val_predictions)
print ("VAL SAVED")

np.save('/home/hpc_lkpiel/predictions/test/model_48.npy', test_predictions)
print ("TEST SAVED")
'''
valResult = model_48.evaluate(val_data_padded, val_labels_age)
testResult = model_48.evaluate(test_data_padded, test_labels_age)

file = open("results.txt","a")
file.write("\nmodel_48 VAL: " + str(valResult) + " TEST: " + str(testResult))
file.close()
print ("WROTE TO FILE model_48")
'''
########################################