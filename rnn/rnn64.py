...
print ("model_64 BUILT")

model_64.compile(loss='categorical_crossentropy', optimizer="adam", metrics=['accuracy'])
print ("model_64 COMPILED")


checkpoint = ModelCheckpoint(filepath='/home/hpc_lkpiel/models/model_64.hdf5', monitor='val_acc', save_best_only=True)
'''
history = model_64.fit(x=train_data_padded,
...
np.save('../history/history_model_64.npy', history.history)
modelHistory = np.load('../history/history_model_64.npy').item()

print ("HISTORY: ")
print (modelHistory)
'''
model_64.load_weights('/home/hpc_lkpiel/models/model_64.hdf5')

val_predictions = model_64.predict(val_data_padded)
print ("VAL PREDICTED")

test_predictions = model_64.predict(test_data_padded)
print ("TEST PREDICTED")

np.save('/home/hpc_lkpiel/predictions/val/model_64.npy', val_predictions)
print ("VAL SAVED")

np.save('/home/hpc_lkpiel/predictions/test/model_64.npy', test_predictions)
print ("TEST SAVED")
'''
valResult = model_64.evaluate(val_data_padded, val_labels_age_group)
testResult = model_64.evaluate(test_data_padded, test_labels_age_group)

file = open("results.txt","a")
file.write("\nmodel_64 VAL: " + str(valResult) + " TEST: " + str(testResult))
file.close()
'''
print ("WROTE TO FILE model_64")
