...
print ("model_39 BUILT")

model_39.compile(loss='categorical_crossentropy', optimizer="adam", metrics=['accuracy'])
print ("model_39 COMPILED")


checkpoint = ModelCheckpoint(filepath='/home/hpc_lkpiel/models/model_39.hdf5', monitor='val_acc', save_best_only=True)
'''
history = model_39.fit(x=train_data_padded,
...
np.save('../history/history_model_39.npy', history.history)
modelHistory = np.load('../history/history_model_39.npy').item()

print ("HISTORY: ")
print (modelHistory)
'''

model_39.load_weights('/home/hpc_lkpiel/models/model_39.hdf5')


val_predictions = model_39.predict(val_data_padded)
print ("VAL PREDICTED")

test_predictions = model_39.predict(test_data_padded)
print ("TEST PREDICTED")

np.save('/home/hpc_lkpiel/predictions/val/model_39.npy', val_predictions)
print ("VAL SAVED")

np.save('/home/hpc_lkpiel/predictions/test/model_39.npy', test_predictions)
print ("TEST SAVED")
'''
valResult = model_39.evaluate(val_data_padded, val_labels_age_group)
testResult = model_39.evaluate(test_data_padded, test_labels_age_group)

file = open("results.txt","a")
file.write("\nmodel_39 VAL: " + str(valResult) + " TEST: " + str(testResult))
file.close()
'''
print ("WROTE TO FILE model_39")
