...
print (model_66.summary)
print ("model_66 BUILT")

model_66.compile(loss='categorical_crossentropy', optimizer="adam", metrics=['accuracy'])
print ("model_66 COMPILED")


checkpoint = ModelCheckpoint(filepath='/home/hpc_lkpiel/models/model_66.hdf5', monitor='val_acc', save_best_only=True)
'''
history = model_66.fit(x=train_data_padded,
...
np.save('../history/history_model_66.npy', history.history)
modelHistory = np.load('../history/history_model_66.npy').item()

print ("HISTORY: ")
print (modelHistory)
'''
model_66.load_weights('/home/hpc_lkpiel/models/model_66.hdf5')

val_predictions = model_66.predict(val_data_padded)
print ("VAL PREDICTED")

test_predictions = model_66.predict(test_data_padded)
print ("TEST PREDICTED")

np.save('/home/hpc_lkpiel/predictions/val/model_66_males_original.npy', val_predictions)
print ("VAL SAVED")

np.save('/home/hpc_lkpiel/predictions/test/model_66_males_original.npy', test_predictions)
'''
valResult = model_66.evaluate(val_data_padded, val_labels_age_group)
testResult = model_66.evaluate(test_data_padded, test_labels_age_group)

file = open("results.txt","a")
file.write("\nmodel_66 VAL: " + str(valResult) + " TEST: " + str(testResult))
file.close()
print ("WROTE TO FILE model_66")
