...
output_layer_1 = Dense(1, name='age_output')(x)
output_layer_2 =  Dense(2, name='gender')(x)

print ("model_91 BUILT")
model_91 = Model(inputs=[input_layer], outputs=[output_layer_1, output_layer_2])

model_91.compile(loss={'age_output':'mse', 'gender':'categorical_crossentropy'},
                    optimizer=SGD(0.01),
                    metrics={'age_output':age_group_accuracy,'gender':'accuracy'})
...
history = model_91.fit([train_data_padded],
    [train_labels_age, train_labels_gender],
    validation_data=([val_data_padded], [val_labels_age, val_labels_gender]),
    epochs=100,
    verbose=1,
    batch_size=64,
...
np.save('../history/history_model_91.npy', history.history)
modelHistory = np.load('../history/history_model_91.npy').item()
...
val_predictions = model_91.predict(val_data_padded)
print ("VAL PREDICTED")

test_predictions = model_91.predict(test_data_padded)
print ("TEST PREDICTED")


np.save('/home/hpc_lkpiel/predictions/val/model_91_age_group.npy', val_predictions[0])
print ("VAL SAVED")

np.save('/home/hpc_lkpiel/predictions/test/model_91_age_group.npy', test_predictions[0])
print ("TEST SAVED")

np.save('/home/hpc_lkpiel/predictions/val/model_91_gender.npy', val_predictions[1])
print ("VAL SAVED")

np.save('/home/hpc_lkpiel/predictions/test/model_91_gender.npy', test_predictions[1])
print ("TEST SAVED")

print ("WROTE TO FILE model_91")
