...
print ("model_17 BUILT")

model_17.compile(loss='categorical_crossentropy', optimizer='adam', metrics=['accuracy'])
print ("model_17 COMPILED")


checkpoint = ModelCheckpoint(filepath='/home/hpc_lkpiel/models/model_17.hdf5', monitor='val_acc', save_best_only=True)

history = model_17.fit(x=train_data_padded,
...
np.save('../history/history_model_17.npy', history.history)
modelHistory = np.load('../history/history_model_17.npy').item()

print ("HISTORY: ")
print (modelHistory)
model_17.load_weights('/home/hpc_lkpiel/models/model_17.hdf5')

valResult = model_17.evaluate(val_data_padded, val_labels_age_group)
testResult = model_17.evaluate(test_data_padded, test_labels_age_group)

file = open("results.txt","a")
file.write("\nmodel_17 VAL: " + str(valResult) + " TEST: " + str(testResult))
file.close()
print ("WROTE TO FILE")
