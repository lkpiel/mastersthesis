...
gender_2 = Sequential([
    ...
    Conv2D(128, (5, 1), strides=(3,1), activation='relu', border_mode='valid'),
    Conv2D(128, (5, 1), strides=(3,1), activation='relu', border_mode='valid'),
...
print (gender_2.summary)
print ("gender_2 BUILT")

gender_2.compile(loss='categorical_crossentropy', optimizer="sgd", metrics=['accuracy'])
print ("gender_2 COMPILED")


checkpoint = ModelCheckpoint(filepath='/home/hpc_lkpiel/models/gender_2.hdf5', monitor='val_acc', save_best_only=True)
'''
history = gender_2.fit(x=train_data_padded,
...
np.save('/home/hpc_lkpiel/history/gender/gender_2.npy', history.history)
modelHistory = np.load('/home/hpc_lkpiel/history/gender/gender_2.npy').item()

print ("HISTORY: ")
print (modelHistory)
'''
gender_2.load_weights('/home/hpc_lkpiel/models/gender_2.hdf5')

val_predictions = gender_2.predict(val_data_padded)
print ("VAL PREDICTED")

test_predictions = gender_2.predict(test_data_padded)
print ("TEST PREDICTED")


np.save('/home/hpc_lkpiel/predictions/val/gender_2.npy', val_predictions)
print ("VAL SAVED")

np.save('/home/hpc_lkpiel/predictions/test/gender_2.npy', test_predictions)
print ("TEST SAVED")
valResult = gender_2.evaluate(val_data_padded, val_labels_gender)
testResult = gender_2.evaluate(test_data_padded, test_labels_gender)
print (str(valResult))
