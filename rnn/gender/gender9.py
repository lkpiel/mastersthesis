...
gender_9 = Sequential([
    TimeDistributed(Dense(2000, activation='relu'),  input_shape=(1107, 20)),
    Dropout(0.5),
    TimeDistributed(Dense(1000, activation='relu')),
    Dropout(0.3),
    Flatten(),
    Dense(2, activation='softmax')
])

print (gender_9.summary)
print ("gender_9 BUILT")

gender_9.compile(loss='categorical_crossentropy', optimizer="sgd", metrics=['accuracy'])
print ("gender_9 COMPILED")


checkpoint = ModelCheckpoint(filepath='/home/hpc_lkpiel/models/gender_9.hdf5', monitor='val_acc', save_best_only=True)
'''
history = gender_9.fit(x=train_data_padded,
...
np.save('/home/hpc_lkpiel/history/gender/gender_9.npy', history.history)
modelHistory = np.load('/home/hpc_lkpiel/history/gender/gender_9.npy').item()

print ("HISTORY: ")
print (modelHistory)
'''
gender_9.load_weights('/home/hpc_lkpiel/models/gender_9.hdf5')

val_predictions = gender_9.predict(val_data_padded)
print ("VAL PREDICTED")

test_predictions = gender_9.predict(test_data_padded)
print ("TEST PREDICTED")


np.save('/home/hpc_lkpiel/predictions/val/gender_9.npy', val_predictions)
print ("VAL SAVED")

np.save('/home/hpc_lkpiel/predictions/test/gender_9.npy', test_predictions)
print ("TEST SAVED")

valResult = gender_9.evaluate(val_data_padded, val_labels_gender)
testResult = gender_9.evaluate(test_data_padded, test_labels_gender)
print (str(valResult))
