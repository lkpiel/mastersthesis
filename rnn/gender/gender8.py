...
gender_8 = Sequential([
    Conv2D(64, (3, 20), activation='relu', border_mode='valid', input_shape=(1107, 20, 1)),
    Conv2D(64, (5, 1), strides=(3,1), activation='relu', border_mode='valid'),
    Reshape((-1, 64)),
...
print (gender_8.summary)
print ("gender_8 BUILT")

gender_8.compile(loss='categorical_crossentropy', optimizer="sgd", metrics=['accuracy'])
print ("gender_8 COMPILED")


checkpoint = ModelCheckpoint(filepath='/home/hpc_lkpiel/models/gender_8.hdf5', monitor='val_acc', save_best_only=True)

history = gender_8.fit(x=train_data_padded,
        y=train_labels_gender,
        validation_data=(val_data_padded, val_labels_gender),
        epochs=30,
        verbose=1,
        batch_size=32,
...
np.save('/home/hpc_lkpiel/history/gender/gender_8.npy', history.history)
modelHistory = np.load('/home/hpc_lkpiel/history/gender/gender_8.npy').item()

print ("HISTORY: ")
print (modelHistory)

gender_8.load_weights('/home/hpc_lkpiel/models/gender_8.hdf5')


val_predictions = gender_8.predict(val_data_padded)
print ("VAL PREDICTED")

test_predictions = gender_8.predict(test_data_padded)
print ("TEST PREDICTED")


np.save('/home/hpc_lkpiel/predictions/val/gender_8.npy', val_predictions)
print ("VAL SAVED")

np.save('/home/hpc_lkpiel/predictions/test/gender_8.npy', test_predictions)
print ("TEST SAVED")


valResult = gender_8.evaluate(val_data_padded, val_labels_gender)
testResult = gender_8.evaluate(test_data_padded, test_labels_gender)
print (str(valResult))
