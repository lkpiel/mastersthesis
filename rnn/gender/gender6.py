...
print (gender_6.summary)
print ("gender_6 BUILT")

gender_6.compile(loss='categorical_crossentropy', optimizer="sgd", metrics=['accuracy'])
print ("gender_6 COMPILED")


checkpoint = ModelCheckpoint(filepath='/home/hpc_lkpiel/models/gender_6.hdf5', monitor='val_acc', save_best_only=True)
'''
history = gender_6.fit(x=train_data_padded,
...
np.save('/home/hpc_lkpiel/history/gender/gender_6.npy', history.history)
modelHistory = np.load('/home/hpc_lkpiel/history/gender/gender_6.npy').item()

print ("HISTORY: ")
print (modelHistory)
'''
gender_6.load_weights('/home/hpc_lkpiel/models/gender_6.hdf5')

val_predictions = gender_6.predict(val_data_padded)
print ("VAL PREDICTED")

test_predictions = gender_6.predict(test_data_padded)
print ("TEST PREDICTED")


np.save('/home/hpc_lkpiel/predictions/val/gender_6.npy', val_predictions)
print ("VAL SAVED")

np.save('/home/hpc_lkpiel/predictions/test/gender_6.npy', test_predictions)
print ("TEST SAVED")

valResult = gender_6.evaluate(val_data_padded, val_labels_gender)
testResult = gender_6.evaluate(test_data_padded, test_labels_gender)
print (str(valResult))
