...
gender_7 = Sequential([
    ...
    Bidirectional(LSTM(256, kernel_constraint=max_norm(max_value=2, axis=0))),
    Dense(2, activation='softmax')
])

print (gender_7.summary)
print ("gender_7 BUILT")

gender_7.compile(loss='categorical_crossentropy', optimizer="sgd", metrics=['accuracy'])
print ("gender_7 COMPILED")


checkpoint = ModelCheckpoint(filepath='/home/hpc_lkpiel/models/gender_7.hdf5', monitor='val_acc', save_best_only=True)
history = gender_7.fit(x=train_data_padded,
...
np.save('/home/hpc_lkpiel/history/gender/gender_7.npy', history.history)
modelHistory = np.load('/home/hpc_lkpiel/history/gender/gender_7.npy').item()

print ("HISTORY: ")
print (modelHistory)
gender_7.load_weights('/home/hpc_lkpiel/models/gender_7.hdf5')

valResult = gender_7.evaluate(val_data_padded, val_labels_gender)
testResult = gender_7.evaluate(test_data_padded, test_labels_gender)
print (str(valResult))
