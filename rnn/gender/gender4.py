...
print (gender_4.summary)
print ("gender_4 BUILT")

gender_4.compile(loss='categorical_crossentropy', optimizer="sgd", metrics=['accuracy'])
print ("gender_4 COMPILED")


checkpoint = ModelCheckpoint(filepath='/home/hpc_lkpiel/models/gender_4.hdf5', monitor='val_acc', save_best_only=True)
'''
history = gender_4.fit(x=train_data_padded,
...
np.save('/home/hpc_lkpiel/history/gender/gender_4.npy', history.history)
modelHistory = np.load('/home/hpc_lkpiel/history/gender/gender_4.npy').item()

print ("HISTORY: ")
print (modelHistory)
'''
gender_4.load_weights('/home/hpc_lkpiel/models/gender_4.hdf5')

val_predictions = gender_4.predict(val_data_padded)
print ("VAL PREDICTED")

test_predictions = gender_4.predict(test_data_padded)
print ("TEST PREDICTED")


np.save('/home/hpc_lkpiel/predictions/val/gender_4.npy', val_predictions)
print ("VAL SAVED")

np.save('/home/hpc_lkpiel/predictions/test/gender_4.npy', test_predictions)
print ("TEST SAVED")

valResult = gender_4.evaluate(val_data_padded, val_labels_gender)
testResult = gender_4.evaluate(test_data_padded, test_labels_gender)
print (str(valResult))
