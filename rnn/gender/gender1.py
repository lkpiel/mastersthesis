...
print (gender_1.summary)
print ("gender_1 BUILT")

gender_1.compile(loss='categorical_crossentropy', optimizer="sgd", metrics=['accuracy'])
...
np.save('/home/hpc_lkpiel/history/gender/gender_1.npy', history.history)
modelHistory = np.load('/home/hpc_lkpiel//history/gender/gender_1.npy').item()
...
val_predictions = gender_1.predict(val_data_padded)
print ("VAL PREDICTED")

test_predictions = gender_1.predict(test_data_padded)
print ("TEST PREDICTED")


np.save('/home/hpc_lkpiel/predictions/val/gender_1.npy', val_predictions)
print ("VAL SAVED")

np.save('/home/hpc_lkpiel/predictions/test/gender_1.npy', test_predictions)
print ("TEST SAVED")

valResult = gender_1.evaluate(val_data_padded, val_labels_gender)
testResult = gender_1.evaluate(test_data_padded, test_labels_gender)
print (str(valResult))
