...
checkpoint = ModelCheckpoint(filepath='/models/gender_3.hdf5', monitor='val_acc', save_best_only=True)
gender_3.load_weights('/models/gender_2.hdf5')
...
print ("HISTORY: ")
print (modelHistory)
gender_3.load_weights('/models/gender_3.hdf5')
