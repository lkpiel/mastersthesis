...
print (model_65.summary)
print ("model_65 BUILT")

model_65.compile(loss='categorical_crossentropy', optimizer="adam", metrics=['accuracy'])
print ("model_65 COMPILED")


checkpoint = ModelCheckpoint(filepath='/home/hpc_lkpiel/models/model_65.hdf5', monitor='val_acc', save_best_only=True)
'''
history = model_65.fit(x=train_data_padded,
...
np.save('../history/history_model_65.npy', history.history)
modelHistory = np.load('../history/history_model_65.npy').item()

print ("HISTORY: ")
print (modelHistory)
'''

model_65.load_weights('/home/hpc_lkpiel/models/model_65.hdf5')

val_predictions = model_65.predict(val_data_padded)
print ("VAL PREDICTED")

test_predictions = model_65.predict(test_data_padded)
print ("TEST PREDICTED")

np.save('/home/hpc_lkpiel/predictions/val/model_65_females_original.npy', val_predictions)
print ("VAL SAVED")

np.save('/home/hpc_lkpiel/predictions/test/model_65_females_original.npy', test_predictions)
print ("TEST SAVED")

'''
valResult = model_65.evaluate(val_data_padded, val_labels_age_group)
testResult = model_65.evaluate(test_data_padded, test_labels_age_group)

file = open("results.txt","a")
file.write("\nmodel_65 VAL: " + str(valResult) + " TEST: " + str(testResult))
file.close()
'''
print ("WROTE TO FILE model_65")
