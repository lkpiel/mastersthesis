...
print (model_84.summary)
print ("model_84 BUILT")

model_84.compile(loss='categorical_crossentropy', optimizer="adam", metrics=['accuracy'])
print ("model_84 COMPILED")


checkpoint = ModelCheckpoint(filepath='/home/hpc_lkpiel/models/model_84.hdf5', monitor='val_loss', save_best_only=True)
'''
history = model_84.fit(x=train_data_padded,
...
np.save('../history/history_model_84.npy', history.history)
modelHistory = np.load('../history/history_model_84.npy').item()

print ("HISTORY: ")
print (modelHistory)
'''
model_84.load_weights('/home/hpc_lkpiel/models/model_84.hdf5')


val_predictions = model_84.predict(val_data_padded)
print ("VAL PREDICTED")

test_predictions = model_84.predict(test_data_padded)
print ("TEST PREDICTED")


np.save('/home/hpc_lkpiel/predictions/val/model_84.npy', val_predictions)
print ("VAL SAVED")

np.save('/home/hpc_lkpiel/predictions/test/model_84.npy', test_predictions)
print ("TEST SAVED")
'''
valResult = model_84.evaluate(val_data_padded, val_labels_age_group)
testResult = model_84.evaluate(test_data_padded, test_labels_age_group)

file = open("results.txt","a")
file.write("\nmodel_84 VAL: " + str(valResult) + " TEST: " + str(testResult))
file.close()
print ("WROTE TO FILE")
'''
########################################