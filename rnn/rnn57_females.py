...
checkpoint = ModelCheckpoint(filepath='/models/model_57_females.hdf5', monitor='val_acc', save_best_only=True)
...
model_57.load_weights('/models/model_57_females.hdf5')
