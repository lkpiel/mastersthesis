...
checkpoint = ModelCheckpoint(filepath='/home/hpc_lkpiel/models/model_57_females.hdf5', monitor='val_acc', save_best_only=True)


history = model_57.fit([train_data_padded, train_i_vectors_females],
...
np.save('../history/history_model_57_females.npy', history.history)
modelHistory = np.load('../history/history_model_57_females.npy').item()

print ("HISTORY: ")
print (modelHistory)


model_57.load_weights('/home/hpc_lkpiel/models/model_57_females.hdf5')

val_predictions = model_57.predict([val_data_padded, val_i_vectors_females])
print ("VAL PREDICTED")

test_predictions = model_57.predict([test_data_padded, test_i_vectors_females])
print ("TEST PREDICTED")


np.save('/home/hpc_lkpiel/predictions/val/model_57_females.npy', val_predictions)
print ("VAL SAVED")

np.save('/home/hpc_lkpiel/predictions/test/model_57_females.npy', test_predictions)
print ("TEST SAVED")
'''
