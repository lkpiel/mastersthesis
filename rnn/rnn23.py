...
print ("model_23 BUILT")

model_23.compile(loss='categorical_crossentropy', optimizer="adam", metrics=['accuracy'])
print ("model_23 COMPILED")


checkpoint = ModelCheckpoint(filepath='/home/hpc_lkpiel/models/model_23.hdf5', monitor='val_loss', save_best_only=True)
'''
history = model_23.fit(x=train_data_padded,
...
np.save('../history/history_model_23.npy', history.history)
modelHistory = np.load('../history/history_model_23.npy').item()

print ("HISTORY: ")
print (modelHistory)
'''
model_23.load_weights('/home/hpc_lkpiel/models/model_23.hdf5')


val_predictions = model_23.predict(val_data_padded)
print ("VAL PREDICTED")

test_predictions = model_23.predict(test_data_padded)
print ("TEST PREDICTED")


np.save('/home/hpc_lkpiel/predictions/val/model_23.npy', val_predictions)
print ("VAL SAVED")

np.save('/home/hpc_lkpiel/predictions/test/model_23.npy', test_predictions)
valResult = model_23.evaluate(val_data_padded, val_labels_age_group)
testResult = model_23.evaluate(test_data_padded, test_labels_age_group)

file = open("results.txt","a")
file.write("\nmodel_23 VAL: " + str(valResult) + " TEST: " + str(testResult))
file.close()
print ("WROTE TO FILE")
