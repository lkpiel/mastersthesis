...
print ("model_10 BUILT")

model_10.compile(loss='categorical_crossentropy', optimizer='adam', metrics=['accuracy'])
print ("model_10 COMPILED")


checkpoint = ModelCheckpoint(filepath='/home/hpc_lkpiel/models/model_10.hdf5', monitor='val_loss', save_best_only=True)

history = model_10.fit(x=train_data_padded,
...
np.save('../history/history_model_10.npy', history.history)
modelHistory = np.load('../history/history_model_10.npy').item()

print ("HISTORY: ")
print (modelHistory)
model_10.load_weights('/home/hpc_lkpiel/models/model_10.hdf5')

valResult = model_10.evaluate(val_data_padded, val_labels_age_group)
testResult = model_10.evaluate(test_data_padded, test_labels_age_group)

file = open("results.txt","a")
file.write("\nmodel_10 VAL: " + str(valResult) + " TEST: " + str(testResult))
file.close()
print ("WROTE TO FILE")
