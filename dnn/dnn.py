...
np.save('../history/dnn_age_group.npy', history.history)
modelHistory = np.load('../history/dnn_age_group.npy').item()
...
predictions = age_group_model.predict(train_i_vectors)
'''
np.save('./dnn_predicted_labels.npy', predictions)
testResult = age_group_model.evaluate(test_i_vectors, test_labels_age_group)
