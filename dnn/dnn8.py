...
x = Dense(4000,  kernel_regularizer=kernel_regularizer,  activation='relu')(input_layer)
x = Dropout(0.7)(x)
x = Dense(2000,  kernel_regularizer=kernel_regularizer,  activation='relu')(x)
x = Dropout(0.4)(x)
x = Dense(300,  kernel_regularizer=kernel_regularizer,  activation='relu')(x)
x = Dropout(0.3)(x)
...
np.save('../history/dnn/dnn_8.npy', history.history)
modelHistory = np.load('../history/dnn/dnn_8.npy').item()
