...
np.save('/home/hpc_lkpiel/predictions/val/dnn_4_males_original.npy', val_predictions[0])

print ("VAL SAVED")

np.save('/home/hpc_lkpiel/predictions/test/dnn_4_males_original.npy', test_predictions[0])
