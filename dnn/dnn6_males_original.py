...
checkpoint = ModelCheckpoint(filepath='/models/dnn_6.hdf5', monitor='val_group_output_acc', save_best_only=True)
...
'''
multi_model.load_weights("/models/dnn_6.hdf5")
...
np.save('/home/hpc_lkpiel/predictions/val/dnn_6_age_group_males_original.npy', val_predictions[0])
np.save('/home/hpc_lkpiel/predictions/val/dnn_6_age_males_original.npy', val_predictions[1])

print ("VAL SAVED")

np.save('/home/hpc_lkpiel/predictions/test/dnn_6_age_group_males_original.npy', test_predictions[0])
np.save('/home/hpc_lkpiel/predictions/test/dnn_6_age_males_original.npy', test_predictions[1])
