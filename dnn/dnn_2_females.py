...
train_labels_females =  train_data_females['Age']
val_labels_females = val_data_females['Age']
...
print ("dnn_2_females MODEL BUILT")

dnn_2_females.compile(
    loss='mse',
...
test_predictions = dnn_2_females.predict(test_i_vectors_females)
print ("TEST PREDICTED")


np.save('/home/hpc_lkpiel/predictions/val/dnn_2_females.npy', val_predictions)
print ("VAL SAVED")

np.save('/home/hpc_lkpiel/predictions/test/dnn_2_females.npy', test_predictions)


print (str(dnn_2_females.evaluate(test_i_vectors_females, test_labels_females)))
print (str(dnn_2_females.evaluate(test_i_vectors_males, test_labels_males)))
