...
test_predictions = dnn_1.predict(test_i_vectors_females)
print ("TEST PREDICTED")

np.save('/home/hpc_lkpiel/predictions/val/dnn_1_females_original.npy', val_predictions)
print ("VAL SAVED")

np.save('/home/hpc_lkpiel/predictions/test/dnn_1_females_original.npy', test_predictions)
