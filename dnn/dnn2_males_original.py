...
val_predictions = dnn_2.predict(val_i_vectors_males)
print ("VAL PREDICTED")

test_predictions = dnn_2.predict(test_i_vectors_males)
print ("TEST PREDICTED")

np.save('/home/hpc_lkpiel/predictions/val/dnn_2_males_original.npy', val_predictions)
print ("VAL SAVED")

np.save('/home/hpc_lkpiel/predictions/test/dnn__males_original.npy', test_predictions)
