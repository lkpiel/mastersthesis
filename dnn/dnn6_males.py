...
train_labels_males_age =  train_data_males['Age']
val_labels_males_age = val_data_males['Age']
test_labels_males_age = test_data_males['Age']
test_labels_females_age = test_data_females['Age']
...
checkpoint = ModelCheckpoint(filepath='/home/hpc_lkpiel/models/dnn_6_males.hdf5', monitor='val_group_output_acc', save_best_only=True)
...
history = multi_model.fit(
    train_i_vectors_males,
    [train_labels_males, train_labels_males_age],
    validation_data=(val_i_vectors_males, [val_labels_males, val_labels_males_age]),
    epochs=25,
    callbacks=[checkpoint]
)


multi_model.load_weights("/home/hpc_lkpiel/models/dnn_6_males.hdf5")

val_predictions = multi_model.predict([val_i_vectors_males])
print ("VAL PREDICTED")

test_predictions = multi_model.predict([test_i_vectors_males])
print ("TEST PREDICTED")




np.save('/home/hpc_lkpiel/predictions/val/dnn_6_age_group_males.npy', val_predictions[0])
np.save('/home/hpc_lkpiel/predictions/val/dnn_6_age_males.npy', val_predictions[1])

print ("VAL SAVED")

np.save('/home/hpc_lkpiel/predictions/test/dnn_6_age_group_males.npy', test_predictions[0])
np.save('/home/hpc_lkpiel/predictions/test/dnn_6_age_males.npy', test_predictions[1])
