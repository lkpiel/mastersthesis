...
checkpoint = ModelCheckpoint(filepath='/models/dnn_6_males.hdf5', monitor='val_group_output_acc', save_best_only=True)
...
multi_model.load_weights("/models/dnn_6_males.hdf5")
