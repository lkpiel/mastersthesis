...
trainMaleIndexes = train_data.index[train_data['Gender'] == 1].tolist()
valMaleIndexes = val_data.index[val_data['Gender'] == 1].tolist()
testMaleIndexes = test_data.index[test_data['Gender'] == 1].tolist()
...
train_labels_females_age =  train_data_females['Age']
val_labels_females_age = val_data_females['Age']
...
checkpoint = ModelCheckpoint(filepath='/home/hpc_lkpiel/models/dnn_6_females.hdf5', monitor='val_group_output_acc', save_best_only=True)
...
history = multi_model.fit(
    train_i_vectors_females,
    [train_labels_females, train_labels_females_age],
    validation_data=(val_i_vectors_females, [val_labels_females, val_labels_females_age]),
    epochs=25,
    callbacks=[checkpoint]
)


multi_model.load_weights("/home/hpc_lkpiel/models/dnn_6_females.hdf5")
...
np.save('/home/hpc_lkpiel/predictions/val/dnn_6_age_group_females.npy', val_predictions[0])
np.save('/home/hpc_lkpiel/predictions/val/dnn_6_age_females.npy', val_predictions[1])

print ("VAL SAVED")

np.save('/home/hpc_lkpiel/predictions/test/dnn_6_age_group_females.npy', test_predictions[0])
np.save('/home/hpc_lkpiel/predictions/test/dnn_6_age_females.npy', test_predictions[1])
