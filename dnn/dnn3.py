...
np.save('../history/dnn/dnn_3.npy', history.history)
modelHistory = np.load('../history/dnn/dnn_3.npy').item()
...
test_predictions = dnn_3.predict(test_i_vectors)
...
np.save('/home/hpc_lkpiel/predictions/test/dnn_3_gender.npy', test_predictions)
print ("TEST SAVED")
