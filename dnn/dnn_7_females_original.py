...
np.save('/home/hpc_lkpiel/predictions/val/dnn_7_females_original_gender.npy', val_predictions[0])
print ("VAL SAVED")

np.save('/home/hpc_lkpiel/predictions/test/dnn_7_females_original_gender.npy', test_predictions[0])
print ("TEST SAVED")
