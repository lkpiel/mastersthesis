...
checkpoint = ModelCheckpoint(filepath='/home/hpc_lkpiel/models/dnn_7.hdf5', monitor='val_gender_output_acc', save_best_only=True)
...
np.save('/home/hpc_lkpiel/predictions/val/dnn_7_males_original_age_group.npy', val_predictions[1])
print ("VAL SAVED")

np.save('/home/hpc_lkpiel/predictions/test/dnn_7_males_original_age_group.npy', test_predictions[1])
print ("TEST SAVED")
