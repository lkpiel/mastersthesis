...
val_predictions = dnn_1.predict(val_i_vectors)
print ("VAL PREDICTED")

test_predictions = dnn_1.predict(test_i_vectors)
print ("TEST PREDICTED")

np.save('/home/hpc_lkpiel/predictions/val/dnn_1.npy', val_predictions)
print ("VAL SAVED")

np.save('/home/hpc_lkpiel/predictions/test/dnn_1.npy', test_predictions)
