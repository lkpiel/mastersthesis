...
np.save('/home/hpc_lkpiel/predictions/val/dnn_6_age_group.npy', val_predictions[0])
np.save('/home/hpc_lkpiel/predictions/val/dnn_6_age.npy', val_predictions[1])

print ("VAL SAVED")

np.save('/home/hpc_lkpiel/predictions/test/dnn_6_age_group.npy', test_predictions[0])
np.save('/home/hpc_lkpiel/predictions/test/dnn_6_age.npy', test_predictions[1])
